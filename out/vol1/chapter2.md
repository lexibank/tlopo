...
PMP permitted CVC syllables both word-finally and word-internally, as in &ast;gapgap 'stammer'. One of the innovations which defines POc is the loss of the final consonant of a word-medial syllable, as in POc &ast;kaka(p). The most common context for this innovation is reduplicated forms like &ast;gapgap ([Blust 1977a](../references.md#source-Blust1977a)), but it also occurred elsewhere; for example, PMP &ast;beR'li 'night' became POc &ast;boŋi.
