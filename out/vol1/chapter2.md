...
Work based on the sound correspondences (Ch. 1, §3.3) of both Oceanic and non-Oceanic languages has resulted in the following reconstructed paradigms of POc consonants and vowels:
...
a)   The PMP voiced/voiceless pairs _&ast;p_, _&ast;b_ and _&ast;k_, _&ast;g_ merged respectively as early pre-POc _&ast;p_ and _&ast;k_. [Ozanne-Rivierre](../references.md#source-OzanneRivierre1992) ([1992](../references.md#source-OzanneRivierre1992)) suggests that the corresponding _&ast;t_, _&ast;d_ merger was hindered by their mismatch in point of articulation (dental vs alveolar).
...
The remarks below on POc word classes and derivational morphology are rather brief, largely because these remain somewhat poorly explored areas. More detail is provided by [Lynch, Ross and Crowley](../references.md#source-Lynchetal2002) ([2002](../references.md#source-Lynchetal2002)), but there is a great deal about POc morphosyntax that we do not know and which is perhaps irretrievable. The major publication on POc grammar is [Pawley](../references.md#source-Pawley1973) ([1973](../references.md#source-Pawley1973)).[^5]
...
__igt__ (1) Boumaa (Fij): ([Dixon 1988](../references.md#source-Dixon1988):204, 231) a. Au   rabe. s:1s kick 'I'm kicking.' b. Au    rabe-t-a     a   polo. s:1s  kick-TR-O:3s ART ball 'I'm kicking the ball.'
...
__igt__ (2) Boumaa (Fij): ([Dixon 1988](../references.md#source-Dixon1988):204, 231) a. E    gagi  a   dovu. s:3s crush ART sugarcane 'The sugarcane is being crushed.' b. Au   gagi-a     a   dovu. s:1s crush-O:3s ART sugarcane 'I'm crushing the sugarcane.'
...
__igt__ (3) Boumaa (Fij): ([Dixon 1988](../references.md#source-Dixon1988):204, 231) E    loaloa   a   ʔolii yai. s:3s be.black ART dog   this 'This dog is black.'

__igt__ (4) Boumaa (Fij): ([Dixon 1988](../references.md#source-Dixon1988):204, 231) E    gagi  a   dovu. s:3s crush ART sugarcane 'The sugarcane is crushed.'
...
There is a tendency both in the reconstruction of POc ([Pawley 1973](../references.md#source-Pawley1973))[^10] and in descriptions of modern Oceanic languages to regard all intransitives with an U subject as stative. In some modern languages this is seems to be correct, but in others, and apparently in POc, they are/were distributed between the classes I have labelled U and U-stative. [^11]
...
|:------|:--------|:--------------------------|:--------------------------------------|:--------------|
|       | A verbs | _&ast;kati_ 'husk with teeth' | _&ast;kati-_ 'husk (s.t.) with teeth'     | (Ch. 9, §3.7) |
|       |         | _&ast;muri_ 'follow'          | _&ast;muri-_ 'follow (s.t./s.o.)'         |               |
|       |         | _&ast;soka_ 'pierce, stab'    | _&ast;soka-i-_ 'pierce, stab (s.t./s.o.)' | (Ch. 9, §4.1) |
...
The consonant of the _-Ci-_ suffix is known as the 'thematic consonant'. Transitive verbs in our data corpus are often cited with a reflex of POc _&ast;a_ o:3s. Where this can readily be omitted because it permutes with other object enclitics, its absence is marked with a hyphen. Where it is not synchronically separable, it is parenthesised in accord with the conventions of Chapter 1, §4.2.

Above, I wrote that transitivising morphology is determined in most cases by the canonic shape of the root. There are some exceptions to this generalisation, and one set of these is discussed by [Blust](../references.md#source-Blust1977a) ([1977a](../references.md#source-Blust1977a)). These consist of forms like those in (9), descended from a PAn or PMP reduplicated monosyllabic root. The intransitive POc form in each case reflects the earlier form with regular loss of the final consonant of the first syllable (§2.2). The transitive form reflects a single monosyllabic root plus an _&ast;-i-_ which by POc times was no longer separable, so that the transitive forms were similar in their behaviour to the transitive forms of vowel-final roots like &ast;kati- 'husk with teeth'.
...
The applicative _&ast;-aki_ or _&ast;-akini_, reconstructed by [Pawley](../references.md#source-Pawley1973) ([1973](../references.md#source-Pawley1973)) as the 'remote transitive' suffix, is attached to an A or U root to form a transitive verb. In its canonic usage, the object of this verb is a referent which would appear as an oblique with the corresponding direct transitive. For example:
...
|:-------|:-----------|:---------|:------------------------------------------------------------|
|        | POc        | &ast;sapaki  | 'pluck off, break off (leaves) with the hand' (Ch. 9, §6.1) |
|        | POc        | &ast;paki    | 'pluck, break off (leaves) with the hand' (Ch. 9, §6.1)     |
|        | POc        | &ast;lopa(k) | 'break' (Ch. 9, §6.2)                                       |

| (14)   | PAn root   | &ast;-Tuk               | 'knock, pound, beat ' ([Blust 1988](../references.md#source-Blust1988): 160- 161) (Ch. 9, §5.1)   |
|:-------|:-----------|:--------------------|:-------------------------------------------------------------|
...
|:-------|:-----------|:--------------------|:------------------------------------------------------------------|
|        | POc        | &ast;potak, &ast;potak-i-   | 'crack open, split open, make incision' (Ch. 9, §3.8)             |
|        | POc        | &ast;botak, &ast;botak-i-   | 'crack open, split open, make incision' (Ch. 9, §3.8)             |
|        | POc        | &ast;pita(k), &ast;pitak-i- | 'break, split' (Ch. 9, §5.2)                                      |

An additional complication consists in the fact that Blust finds PAn/PMP roots which differ only in the voicing of the root-initial consonant and which have similar meanings. Since PAn/PMP voicing distinctions were not retained in POc (§2.4), their reflexes are indistinguishable in Oceanic languages. Thus POc _&ast;tupu(k)_, _&ast;tupu(k)-i-_ 'knock against', apparently reflecting PMP _&ast;tu(m)buk_ 'pound', is attributed by Blust (ACD) to the PAn root _&ast;-buk_ 'pound, thud, heavy splash' ([Blust 1988](../references.md#source-Blust1988): 87-88). POc _&ast;sapu(k)_, _&ast;sapu(k)-i-_ 'hit', on the other hand, apparently reflecting PMP _&ast;sa(m)puk_ 'collide, bump into', is attributable to the PAn root _&ast;-puk_ 'throb, thud, clap, break' ([Blust 1988](../references.md#source-Blust1988): 87-88) (cognate sets in Ch. 9, §5.1).

PAn monosyllabic roots probably ceased to be independent morphemes (if indeed they ever were independent) sometime around the break-up of PAn, although they may well have played a role in the phonaesthetics of daughter languages for some time after the break-up. The other dead patterns I wish to consider, however, probably arose from morphology which remained productive in Eastern Malayo-Polynesian until not long before the break-up of POc. This is morphology which reflects the Austronesian 'focus' system, variants of which occur in many non-Oceanic Austronesian languages. I present the reconstructed systemic changes first, then the instances of them, partly because the systemic changes also have a bearing on POc nominal morphology, discussed in §3.2.1.
...
: The PMP verbal system (based on [Wolff 1973](../references.md#source-Wolff1973) and [Ross 1995a](../references.md#source-Ross1995a))
...
Note that the verbal morphology reconstructed in the rightmost column of (18) is what has been described in §3.1.2. The only additions are the parenthesised forms, representing possible fossils. Evidence for these is given in (19).
...
|        | _&ast;da(n)daŋ_  | _&ast;naŋ_        | _&ast;raŋi-_, _&ast;naŋ_   | 'shine' (Ch. 9, § 11) |
|        | _&ast;buni_      | _&ast;muni_       | _&ast;puni-_, _&ast;muni-_ | 'hide (VT)'           |

: POc relic verb forms ([Ross 1988](../references.md#source-Ross1988): 41-42 gives supporting data)
...
Forms reflecting _&ast;√-aŋ_ are found in languages of the NNG cluster. Here, however, there is a different complication, namely that _&ast;√-aŋ_ and _&ast;√-aŋa_ are reflected as _&ast;√-ŋ_ and _&ast;√-ŋa_, e.g. _&ast;mate-aŋa_ 'death' is replaced by _&ast;mate-ŋa_, getting rid of the vowel sequence in favour of the strongly CV canonic shape of early Oceanic (§2.2). This is evidently a local innovation. Thus we find, for example, Lukep-Pono _kani-ŋ_ 'yam' (from _&ast;kani_ 'eat'), Gitua _gururu-ŋ_ (N) 'thunder' (from _&ast;guru_ (v) 'thunder').
...
Although we know with reasonable certainty what the open word classes were in POc and what their major subclasses were,[^27] we cannot always assign a reconstructed etymon to a single word class or subclass. Some items, of course, like _&ast;tama-_ 'father', _&ast;Rumaq_ 'house' and _&ast;kinit-i-_, are easily assigned: they are, respectively, a monovalent noun, a zero-valency noun and a transitive verb. Quite a number of the items we reconstruct are derived items, and their morphology allows us to assign them to a class. Relevant morphemes are described above in §3.1.2 and §3.2.1, Other items, especially zero-valency nouns and intransitive verbs, the comparative evidence suggests, could readily serve in more than one word class without any morphological change. Thus in cases like POc &ast;(p,pʷ)anaq (N) 'bow', (VI) 'shoot' (Ch. 8 , §9) we assume that the etymon served as both a noun and verb in POc.
...
[^2]:   The languages and sources are: Loniu (Admiralties, [Hamel 1994](../references.md#source-Hamel1994):7-8), Manam (WOc, NNG, [Lichtenberk 1983](../references.md#source-Lichtenberk1983): 21 -32), Tawala (WOc, PT, [Ezard 1997](../references.md#source-Ezard1997)), Nakanai (WOc, MM, [Johnston 1980](../references.md#source-Johnston1980): 247-248), Kwaio (EOc, SES, [Keesing 1985](../references.md#source-Keesing1985): 8-9), Longgu (EOc, SES, [Hill 1992](../references.md#source-Hill1992)), Nguna (EOc, NCV, [Schütz 1969](../references.md#source-Schutz1969): 11 - 12), Boumaa Fijian (EOc, Fij, [Dixon 1988](../references.md#source-Dixon1988): 15- 16).
...
[^4]:  PMP etyma with an unambiguous initial _&ast;g-_ are rare, and this example shows a mismatch between the vowels of PMP and POc (see Ch. 9, §7).

[^5]:  [Pawley's](../references.md#source-Pawley1972) ([1972](../references.md#source-Pawley1972)) reconstruction of PEOc grammar is also relevant to POc reconstruction, particularly as it is not clear that EOc was a discrete interstage, and features reconstructed for PEOc may consequently be attributable to POc.

[^6]:  In order to reconstruct the POc verbal system, I have consulted grammars which (a) are sufficiently detalled and (b) describe languages which seem phonologically and morphologically quite conservative. There are not many of these: I have consulted descriptions of Manam (WOc, NNG) ([Lichtenberk 1983](../references.md#source-Lichtenberk1983)), Hoava (WOc, MM) ([Davis 1997](../references.md#source-Davis1997)), Kwaio ([Keesing 1985](../references.md#source-Keesing1985)) and Longgu (Hill (992) (both EOc, SES), Ambae (Catriona Hyslop, pers.comm.) and Malo ([Jauncey 1997](../references.md#source-Jauncey1997)) (both EOc, NCV) and Boumaa Fijian (EOc, Fij) ([Dixon 1988](../references.md#source-Dixon1988)). The criterion of morphological conservatism is the sharing of morphosyntactic features across djfferent Oceanic subgroups. Unfortunately, we have no grammar of an Admiralties language which is sufficiently detalled.
...
[^9]:   The terms 'actor' and 'undergoer' are from [Foley and van Valin](../references.md#source-FoleyvanValin1984) ([1984](../references.md#source-FoleyvanValin1984)). [Dixon](../references.md#source-Dixon1988) ([1988](../references.md#source-Dixon1988)) uses A and O. [Arms](../references.md#source-Arms1974a) ([1974a](../references.md#source-Arms1974a)), [Foley](../references.md#source-Foley1976) ([1976](../references.md#source-Foley1976)) and others use A (actor/agent) and P (patient), but this labelling is infelicitous in today's terms as it confuses macrorole (A, U) and role (agent, patient, experiencer, theme etc.). The distinctions between the three classes were first demonstrated systematically by [Pawley](../references.md#source-Pawley1973) ([1973](../references.md#source-Pawley1973): 126- 140) with data from Motu (PT), Roviana (MM), Kwara'ae (SES), Arosi (SES), and Bauan Fijian. The seminal work on Fijian A and U verbs is [Arms](../references.md#source-Arms1974a) ([1974a](../references.md#source-Arms1974a)). [Biggs](../references.md#source-Biggs1974) ([1974](../references.md#source-Biggs1974)) addresses parallel issues in Polynesian, [Foley](../references.md#source-Foley1976) ([1976](../references.md#source-Foley1976)) in Malayo-Polynesian. Boumaa Fijian examples in this section are from [Dixon](../references.md#source-Dixon1988) ([1988](../references.md#source-Dixon1988):204, 231).
...
[^17]: The fact that U-stative roots could only be transitivised with _&ast;pa[ka]-_ was one of the features of this verb class recognised by Pawley ([Pawley 1973](../references.md#source-Pawley1973): 128- 129) and used to distinguish it from what I have here called the U class.
...
[^24]: When a monovalent noun had a non-specific possessor, it was evidently linked to the latter by the preposition _&ast;qi_, e.g. _&ast;natu qi boRok_ 'piglet' (lit. 'child of pig'), but there is considerable evidence that _&ast;qi_ was bound to the preceding monovalent noun (cf, for example, Seimat (Admiralties) _nat-i pou_ 'piglet'; see [Hooper 1985](../references.md#source-Hooper1985) for further evidence). A description of the (quite complex) POc possessive system is beyond our scope. The interested reader is referred to [Pawley](../references.md#source-Pawley1973) ([1973](../references.md#source-Pawley1973):153-169), [Lichtenberk](../references.md#source-Lichtenberk1985a) ([1985a](../references.md#source-Lichtenberk1985a)), [Hooper](../references.md#source-Hooper1985) ([1985](../references.md#source-Hooper1985)), [Lynch](../references.md#source-Lynch1996a) ([1996a](../references.md#source-Lynch1996a)).
