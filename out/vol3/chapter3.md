...
The determination of ethnobotanical taxonomies in other modern Oceanic societies has been based on dictionaries and lexicons and so the conclusions are less certain. However, such dictionary searches do suggest that a number of other Oceanic languages, including Nduke (Meso-Melanesian, [Scales n.d.](../sources/Scalesnd)), Arosi (SE Solomonic, [Fox 1978](../sources/Fox1978)) and Samoan (Polynesian, [Milner 1966](../sources/Milner1966)), have systems of ethnobotanical classification that are not greatly different from that of Kwara'ae and Wayan Fijian. Figure 3.6 shows schematically an Arosi taxonomy that can be constructed from plant names in Fox's dictionary.[^4]
...
Nduke speakers distinguish seven primary taxa of plants. The term _ɣae_, primarily used to denote 'trees' can also be used to refer to all plants ([Scales n.d.](../sources/Scalesnd)).
...
In Samoan there appear to be at least six primary taxa of plants, as shown below with the terms and definitions from [Milner](../sources/Milner1966) ([1966](../sources/Milner1966)). Samoan _lāʔau_, as well as being the generic term which denotes 'trees', also appears to be used as the generic term for all plants and occurs as the initial element in a number of plant names, including trees (_lāʔau lopā_ 'red sandalwood, Adenanthera species'), shrubs (_laʔau failafa_ 'candelabra bush, Cassia species'), herbs (_lāʔau faimoti_ 'herb, Euphorbia species'), and woody vines (_lāʔau ʔie_ 'liane, Freycinetia species').
...
:   Tree or shrub -generic name for plants with woody stems and branches, probably
    not including palms or tree-ferns ([§4.2](../contributions/3-3#s-4-2)).

_&ast;waRoc_
:   Generic term for vines and creepers, plants with creeping or climbing growth structure ([§4.4](../contributions/3-3#s-4-4)).

_&ast;pali[sj]i_
:   Generic term for grasses and other 'grass-like' plants ([§4.5](../contributions/3-3#s-4-5)).

_&ast;limut_, _&ast;lumut_
:   Generic term for mosses, algae and seaweeds ([§4.6](../contributions/3-3#s-4-6)).

_&ast;taliŋa_
:   Generic term for mushrooms and fleshy fungi ([§4.7](../contributions/3-3#s-4-7)).
...
<tr>
<td>Mic</td><td><a href="../languages/trukese">Trukese</a></td><td><i>fɔta-</i></td>
<td>
