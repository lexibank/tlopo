...
[Ross](Source#cldf:Ross1996c) ([1996c](Source#cldf:Ross1996c):69) writes that most Oceanic languages have quite a simple pot terminology with three or four main terms.
...
There is fair agreement across Oceanic languages about the structure of the terminology—Ross provides evidence from NNG, PT, Admiralties and Fijian languages which all have terms (not necessarily cognate) for pot (generic), cooking pot, water jar, bowl/dish and frying pan (see [Figure 4](#fig-1-4))—and we have PMP reconstructions in support of corresponding POc terms. However, our cognate sets are disappointingly small. Of our reconstructions, the cooking pot/generic term is the most soundly based.

<a id="fig-1-4"> </a>

[__Figure 4:__ Typical pot shapes (from Ross_1996c) (a) cooking pot: POc _&ast;kuran_, POc _&ast;bʷafja_ (b) water jar: POc _&ast;kalala(ŋ)_, PNGOc _&ast;bʷad(r)i_ (c) bowl: PPT _&ast;na(q)u(q)_ (d) frying pan: POc _&ast;palafja_](MediaTable#cldf:fig-1-4)
...
[PMP &ast;_kuDen_](cognatesetreferences.csv#cldf:1-4-2-1-68-POc-kuron-a)
...
[PNGOc &ast;_bʷad(r)i_](cognatesetreferences.csv#cldf:1-4-2-1-69-PNGOc-badri-a)
...
[PMP &ast;_balaŋa_](cognatesetreferences.csv#cldf:1-4-2-1-70-POc-palaa-a)
...
[PMP &ast;_báŋaq_](cognatesetreferences.csv#cldf:1-4-2-1-70-POc-baa-a)
...
[PMP &ast;_tub-tub_](cognatesetreferences.csv#cldf:1-4-2-1-71-POc-tutup-a)

[PMP &ast;_tub-an_](cognatesetreferences.csv#cldf:1-4-2-1-71-POc-tupan-a)

Note that _&ast;tup-a((n,ŋ))_ is a nominalised form derived from _&ast;[tu]tup_, _&ast;tupi_ (see discussion of nominalisations in [Chapter 2, §3.2.1](ContributionTable?anchor=s-3-2-1#cldf:1-2)).
...
[POc &ast;_tabiRa_](cognatesetreferences.csv#cldf:1-4-2-2-72-POc-tabira-a)

<a id="fig-1-5"> </a>

[__Figure 5:__ POc _&ast;tabiRa_ 'wooden bowl'](MediaTable#cldf:fig-1-5)
...
[PNGOc &ast;_gabom_](cognatesetreferences.csv#cldf:1-4-2-2-73-PNGOc-gabom-a)
...
[PCP &ast;_kumete_](cognatesetreferences.csv#cldf:1-4-2-2-73-PCP-kumete-a)
...
[POc &ast;_(b,bʷ)ilo_](cognatesetreferences.csv#cldf:1-4-2-2-73-POc-bbilo-a)

[POc &ast;_lasa_](cognatesetreferences.csv#cldf:1-4-2-2-73-POc-lasa-a)


<a id="p-74"></a>

[PEMP &ast;_ubi_](cognatesetreferences.csv#cldf:1-4-2-2-74-POc-ubi-a)

<a id="fig-1-6"> </a>

[__Figure 6:__ POc _&ast;(b,bʷ)ilo_ 'coconut shell used as liquid container', POc _&ast;lasa_, POc _&ast;ubi_/_&ast;ibu_ 'coconut half shell-cup' __Figure 7__: POc _&ast;kulopi_ 'cup, ladle' (from Nevermann_1934: 179)](MediaTable#cldf:fig-1-6)



[PMP &ast;_ka(ŋ)bu(q)_](cognatesetreferences.csv#cldf:1-4-2-2-74-POc-kabu-a)
...
[POc &ast;_kulopi_](cognatesetreferences.csv#cldf:1-4-2-2-75-POc-kulopi-a)

An additional reconstruction, POc _&ast;asu_ (V) 'scoop or ladle out' ; (N) 'ladle, bailer', from PMP _&ast;aŋsu_ 'scoop or bail out' is included in [Chapter 7, §7.4](ContributionTable?anchor=s-7-4#cldf:1-7).

The following set, from [Ross](Source#cldf:Ross1996a) ([1996a](Source#cldf:Ross1996a)), is listed because explanation is needed for the fact that it is apparently reflected only in Yapese and NNG languages: is it a retention or a borrowing? (Takia _-ae-_, Bilibil, Megiar _-ai-_ reflect _&ast;-a-_ which has undergone umlaut because of a lost final _&ast;-i_.)

[POc &ast;_d(r)ag(i)_](cognatesetreferences.csv#cldf:1-4-2-2-75-POc-dragi-a)
...
[PSHWNG &ast;_waip_](cognatesetreferences.csv#cldf:1-4-2-2-75-PSHWNG-waip-a)
...
[POc &ast;_joŋ-a(n,ŋ)_](cognatesetreferences.csv#cldf:1-4-2-2-76-POc-joan-a)

This is a nominalisation of the verb below (cf. [Ch. 2, §3.2.1](ContributionTable?anchor=s-3-2-1#cldf:1-2)):

[PAn &ast;_seŋseŋ_](cognatesetreferences.csv#cldf:1-4-2-2-76-POc-jojo-a)
...
[POc &ast;_buruŋ(a)_](cognatesetreferences.csv#cldf:1-4-2-2-76-POc-burua-a)

[PEOc &ast;_bʷalu_](cognatesetreferences.csv#cldf:1-4-2-2-76-PEOc-balu-a)
...
[POc &ast;_d(r)amut_](cognatesetreferences.csv#cldf:1-4-2-2-77-POc-dramut-a)
...
[__Figure 8:__ POc _&ast;d(r)amut_ 'lime spatula'](MediaTable#cldf:fig-1-8)
...
[PMP &ast;_ka(n)tuŋ_](cognatesetreferences.csv#cldf:1-4-2-3-77-POc-katum-a)

Arosi _-s-_ from _&ast;-t-_ is conditioned by a following _&ast;-u_, supporting its reconstruction rather than that of _&ast;-o_. Carolinian _xɔ̄t_ and some other Micronesian cognates are problematic, since their _-t_ reflects POc _&ast;s_ or _&ast;j_ rather than _&ast;t_.


<a id="p-78"></a>

[POc &ast;_laka_](cognatesetreferences.csv#cldf:1-4-2-3-78-POc-laka-a)

[POc &ast;_ta(b,bʷ)e_](cognatesetreferences.csv#cldf:1-4-2-3-78-POc-tabbe-a)
...
[__Figure 9:__ Reconstructions (non-specific) include: POc _&ast;katu(m,ŋ)_ 'basket', POc _&ast;laka_ 'basket ', POc _&ast;tab(w)e_ 'basket, probably small', POc _&ast;taŋa_ 'basket or bag, small, used for personal effects' (after Koch_1986: 104 and n.d.:59)](MediaTable#cldf:fig-1-9)
...
[POc &ast;_taŋa_](cognatesetreferences.csv#cldf:1-4-2-3-79-POc-taa-a)
...
Two further terms have been reconstructed for PPn only: _&ast;fala_ 'plaited pandanus mat', and _&ast;fāliki_ 'cover floor with mats or grass; floor covering', both from Biggs (1993).
...
[PMP &ast;_batuR_](cognatesetreferences.csv#cldf:1-4-3-1-81-POc-patur-a)


<a id="p-82"></a>

[PMP &ast;_añam_](cognatesetreferences.csv#cldf:1-4-3-1-82-POc-ana-a)

[POc &ast;_paus_](cognatesetreferences.csv#cldf:1-4-3-1-82-POc-paus-a)

[POc &ast;_tiki_](cognatesetreferences.csv#cldf:1-4-3-1-82-POc-tiki-a)

[POc &ast;_pai_](cognatesetreferences.csv#cldf:1-4-3-1-82-POc-pai-a)

Biggs (1993) adds one lower-level reconstruction: PPn _&ast;laŋa_ 'plait (mat, basket) .


<a id="p-83"></a>

Ann Chowning (pers.comm.) has offered an additional sense to POc _&ast;raraŋ_, _&ast;raraŋ-i-_ (from PAn _&ast;da(n)daŋ_), which Lichtenberk glosses as 'warm oneself by fire'; 'warm up, reheat (esp. food)' (see [Chapter 6, §3.5](ContributionTable?anchor=s-3-5#cldf:1-6), for the full cognate set). She contributes cognates from Molima, Kove and Nakanai which all refer to the preparation of pandanus leaves for mat making by softening them over a fire, and accord closely with the gloss of the single Polynesian cognate.

[POc &ast;_raraŋ_](cognatesetreferences.csv#cldf:1-4-3-1-83-POc-rara-a)
...
[POc &ast;_tali_](cognatesetreferences.csv#cldf:1-4-3-2-83-POc-tali-a)


<a id="p-84"></a>

[PMP &ast;_piri(c,t)_](cognatesetreferences.csv#cldf:1-4-3-2-84-POc-piri-a)

[PEOc &ast;_piri-piri_](cognatesetreferences.csv#cldf:1-4-3-2-84-PEOc-piripiri-a)


<a id="p-85"></a>

Reduplication was regularly used to form intransitive verbs from verbs which were otherwise transitive (see [Ch. 2, §3.1.2](ContributionTable?anchor=s-3-1-2#cldf:1-2)).
...
[POc &ast;_saqi(t)_](cognatesetreferences.csv#cldf:1-4-3-2-86-POc-saqit-a)

[PMP &ast;_cukcuk_](cognatesetreferences.csv#cldf:1-4-3-2-86-POc-susuk-a)


<a id="p-87"></a>

In the following set there may be some blending of meaning between two formally close terms, POc _&ast;s(u,i)ri_ 'pierce, poke' ([Ch. 9, §4.1](ContributionTable?anchor=s-4-1#cldf:1-9)) and POc _&ast;suRi_ 'bone', because needles were at times made from bones (of bird or flying fox or occasionally pig).

[POc &ast;_(su)suRi_](cognatesetreferences.csv#cldf:1-4-3-2-87-POc-susuri-a)
...
[PMP &ast;_zaRum_](cognatesetreferences.csv#cldf:1-4-3-2-87-POc-sarum-a)
...
[__Figure 10:__ POc _&ast;kiRam_ 'stone adze, axe', POc _&ast;matau_ 'axe', POc _&ast;taku_, POc _&ast;taRa(q)_ 'adze'](MediaTable#cldf:fig-1-10)



[PMP &ast;_kiRam_](cognatesetreferences.csv#cldf:1-4-4-1-88-POc-kiram-a)
...
[POc &ast;_matau_](cognatesetreferences.csv#cldf:1-4-4-1-89-POc-matau-a)

[POc &ast;_(m,mʷ)ata-_](cognatesetreferences.csv#cldf:1-4-4-1-89-POc-mmata-a)
...
[1-4-4-1-89-adm-loniu-mati](cf.csv#cldf:1-4-4-1-89-adm-loniu-mati)


<a id="p-90"></a>

[PMP &ast;_ta(ŋ)kub_](cognatesetreferences.csv#cldf:1-4-4-1-90-POc-taku-a)

[PMP &ast;_(t,T)aRaq_](cognatesetreferences.csv#cldf:1-4-4-1-90-POc-taraq-a)

The existence of axe and adze heads with characteristic shaping to accommodate a handle, together with reconstruction of a term clearly designating 'handle of adze or axe' indicates that POc speakers were familiar with a stone head hafted to a wooden handle. This would have been by means of gum adhesives and cordage, much as described by latter day ethnographers (e.g. [Oliver 1974](Source#cldf:Oliver1974): 135-137 for Tahiti).

[PMP &ast;_paRada_](cognatesetreferences.csv#cldf:1-4-4-1-90-POc-pparara-a)

With regard to the reconstruction of _&ast;(p,pʷ)_, see [Chapter 2, §2.1](ContributionTable?anchor=s-2-1#cldf:1-2). Western Oceanic and SES languages show assimilation of POc _&ast;r_ to _&ast;R_, but we assume that assimilation had not occurred in POc, since, as Blust points out, Puluwat _r_ reflects POc _&ast;r_, whilst Woleaian _ṣ_ inexplicably reflects POc _&ast;dr_. One of the Arosi reflexes and the Raga, Puluwat and Woleaian reflexes show haplology.
...
[PMP &ast;_pisaw_](cognatesetreferences.csv#cldf:1-4-4-1-91-POc-piso-a)
...
[PEOc &ast;_sele_](cognatesetreferences.csv#cldf:1-4-4-1-91-PEOc-sele-a)
...
[PEAd &ast;_care_](cognatesetreferences.csv#cldf:1-4-4-1-92-PEAd-care-a)

Biggs (1993) includes one further reconstruction for 'bamboo knife', PPn _&ast;kofe_.
...
[__Figure 11:__ POc _&ast;nad(r)i_ 'flint, obsidian, stone with a cutting edge'; POc _&ast;koto_ 'obsidian knife or blade'](MediaTable#cldf:fig-1-11)
...
[POc &ast;_nad(r)i_](cognatesetreferences.csv#cldf:1-4-4-1-93-POc-nadri-a)

[PWOc &ast;_qa(r,R)iŋ_](cognatesetreferences.csv#cldf:1-4-4-1-93-PWOc-qarri-a)

[POc &ast;_koto_](cognatesetreferences.csv#cldf:1-4-4-1-93-POc-koto-a)

A group of eastern Polynesian languages have a term for obsidian probably derived from POc _&ast;(m,mʷ)ata_ 'cutting edge' ([§4.1.1](ContributionTable?anchor=s-4-1-1#cldf:1-4)).

[1-4-4-1-93-pn-rapanui-mata](cf.csv#cldf:1-4-4-1-93-pn-rapanui-mata)
...
Multi-purpose piercing tools may have been carried, fashioned from bone, perhaps a pig's femur. These were useful for piercing shells, splitting fibres for weaving, splitting areca nuts, separating coconut meat from its shell and such daily activities. They were probably also used to pierce earlobes and the nasal septum. [Green](Source#cldf:Green1979) ([1979](Source#cldf:Green1979):39) lists a worked pig-tusk piercing tool from the Main Reef Islands, circa 1100 B.C. Reconstructions appear primarily verbal, with a term for the instrument sometimes derivable from the verb. They include  POc _&ast;puru(k)_, _&ast;puruk-i-_ 'pierce, bore (hole)', POc _&ast;buru_ 'bore a hole, drill'; PWOc _&ast;bʷaR(i,e)_ 'bore (hole)'; and PEOc _&ast;paRo_ 'drill through, pierce, perforate' (see [Chapter 9, §4.2](ContributionTable?anchor=s-4-2#cldf:1-9), for the cognate sets).
...
[PAn &ast;_Sasaq_](cognatesetreferences.csv#cldf:1-4-4-1-94-POc-asaq-a)


<a id="p-95"></a>

[PMP &ast;_kirkir_](cognatesetreferences.csv#cldf:1-4-4-1-95-POc-kiri-a)

[POc &ast;_giri_](cognatesetreferences.csv#cldf:1-4-4-1-95-POc-giri-a)
...
The same terms may have also been used to describe the actions of smoothing and polishing. The Polynesians, in particular, were concerned to produce a fine finish to their artefacts by rubbing. Beaglehole wrote of the Tahitians, "All their [wood] work however acquires a certain neatness in the finishing for they polish every thing, even the side of a canoe or a Post of a house, with Coral sand rubbed on in the outer husk of a Cocoa nut and rays skin, which makes them very smooth and neat." (quoted in [Oliver 1974](Source#cldf:Oliver1974): 134). The general term for this may have been POc _&ast;quju(r)_ 'rub, make smooth by rubbing' (see [Ch. 9, §2.3](ContributionTable?anchor=s-2-3#cldf:1-9)). In at least one language (Woleaian in Micronesia) the term for a file is the same term as that for stingray (_faiya_ > PAn _&ast;paRis_ 'stingray'), the skin of which serves as a fine abrasive.
...
The material used to make bark-cloth or tapa in the Pacific area is obtained mainly from various species of trees belonging to the genera _Broussonetia_, _Artocarpus_, and _Ficus_, all of which belong to the family Moraceae. Wherever _tapa_ was made, the _Broussonetia papyrifera_ or paper mulberry tree was used for the highest quality cloth. It is not native to the Pacific, but to eastern Asia, whence migrants carried it to Indonesia and the Pacific. The only other significant source is the _Pipturus_ species, used for _tapa_ particularly in Hawaii ([Kooijman 1972](Source#cldf:Kooijman1972): 1).


<a id="p-96"></a>

Bark-cloth is a significant item in Indonesia and in the eastern Oceanic region, particularly Polynesia, but also Santa Cruz, New Caledonia and Fiji. However, it does not feature strongly in the western Oceanic region. [Ivens](Source#cldf:Ivens1918) ([1918](Source#cldf:Ivens1918): 186) wrote that although bark-cloth (_tapa_) was made in Melanesia, it never figured as an article of clothing, and its main use was to form a kind of shawl in which the baby was slung when carried from the shoulder. Ivens was probably speaking from a Solomons perspective. [Kooijman](Source#cldf:Kooijman1972) ([1972](Source#cldf:Kooijman1972):446) quotes reports by Chalmers and Gill (1885) which mention bark-cloth from Collingwood Bay and the Gulf of Papua (both PT); while in the Northern Province of south-east Papua, for instance, bark-cloth is a prestigious valuable. In parts of New Britain it was used to bind the heads of young babies to achieve the desired elongated skull shape (Ann Chowning, pers.comm.). Kooijman (pp.446-453) points out that the descriptions of the manufacture of New Guinea bark-cloth and the study of the museum material indicate that, as a rule, this _tapa_ is relatively thick and stiff and made from _Ficus_ and Artocarpus varieties, rather than from Broussonetia. He believes that the latter was probably not used for _tapa_ cloth in New Guinea. He records little mention of bark-cloth use in Micronesia, other than the wearing of _tapa_ ponchos in Ponape. [Yen](Source#cldf:Yen1973) ([1973](Source#cldf:Yen1973):83), in his examination of the origins of Oceanic agriculture, describes the cultivation of paper mulberry, as a pruned shrub for the production of bark for cloth, as ceasing west of the Melanesia/Polynesia border area.

<a id="fig-1-12"> </a>

[__Figure 12:__ POc _&ast;ike_ 'tapa beater'](MediaTable#cldf:fig-1-12)



Although terms can be located in WOc, none are cognate, and no POc term is reconstructable, apart from terms for the sources of raw material, POc _&ast;(m,mʷ)ase_ 'wild mulberry, paper mulberry, '_Broussonetia papyrifera_' POc _&ast;kuluR_ 'breadfruit, _Artocarpus_' (from PAn _&ast;kuluR_) and POc _&ast;nunu(k)_ (from PMP _&ast;nunuk_ 'banyan, _Ficus_ spp.') (see Plants, vol. 3).

The term _tapa_, now virtually the generic term for bark-cloth, can be reconstructed for PCP.

[PCP &ast;_taba_](cognatesetreferences.csv#cldf:1-4-5-1-96-PCP-taba-a)

Note that although the general term for bark-cloth in Tonga is _ŋatu_ and in Samoa is _siapo_, the term _tapa_ does exist in both places. In Tonga today it refers more generally to 'edge, rim, border, boundary', and in Samoa it refers to the uncoloured border of the coloured bark-cloth sheet or _siapo_. Biggs (1993) lists these as apparently unrelated homonyms. Alternatively, if we assume the original PPn meaning of _&ast;tapa_ to be 'bark-cloth which was not printed or stained', its more restricted meaning in Samoa is understandable.
...
[PPn &ast;_siapo_](cognatesetreferences.csv#cldf:1-4-5-1-97-PPn-siapo-a)

A number of reconstructions have been made at PCP or PPn level, but the similarity of gloss indicates the likelihood of more subtleties of meaning than we have been able to identify here. They include: PCP _&ast;ŋatu_ 'old or worn bark-cloth', PCP _&ast;leu-leu_ '(old) tapa cloth', and PPn _&ast;ŋafi-ŋafi_ 'old mat or bark-cloth' ([Biggs & Clark 1993](Source#cldf:BiggsandClark1993)).

The only term reconstructable for the Southeast Solomons is apparently limited to the island of Malaita.

[1-4-5-1-97-ses-lau-maku](cf.csv#cldf:1-4-5-1-97-ses-lau-maku)

We have a reconstruction for the mallet used in beating _tapa_ which goes back as far as PMP:

[PMP &ast;_ike_](cognatesetreferences.csv#cldf:1-4-5-1-97-POc-ike-a)


<a id="p-98"></a>

Biggs (1993) has PPn reconstructions for the action of beating _tapa_ (_&ast;tutu_), and the board or anvil on which this was done (_&ast;tutua_). Both terms are derived from PAn _&ast;tuqtuq_ 'hammer, pound, crush ', POc _&ast;tutuk_ (see [Ch. 9, §5.1](ContributionTable?anchor=s-5-1#cldf:1-9)). It is of interest that the Toradja of central Sulawesi also have a term _totua_ for the wooden board on which the bark-cloth is beaten ([Kennedy 1934](Source#cldf:Kennedy1934)).
...
The following reconstruction of POc _&ast;malo_ is soundly based, although there is doubt as to whether the term can be traced back to an earlier stage. [Blust](Source#cldf:Blust1970) ([1970](Source#cldf:Blust1970): 133) proposes PMP _&ast;maru_ 'loincloth', but notes the difficulty of reconciling the PMP form with the POc, with the latter having unexplained _&ast;o_ for expected _&ast;u_ and _&ast;l_ for expected _&ast;r_. There can be little doubt that the POc term referred to bark-cloth and a garment made from that material.

[POc &ast;_malo_](cognatesetreferences.csv#cldf:1-4-5-2-98-POc-malo-a)
...
[POc &ast;_tipi_](cognatesetreferences.csv#cldf:1-4-5-2-99-POc-tipi-a)
...
[PMP &ast;_lumuk_](cognatesetreferences.csv#cldf:1-4-5-3-100-POc-lumuk-a)
...
[POc &ast;_pani_](cognatesetreferences.csv#cldf:1-4-5-3-101-POc-pani-a)

Chowning (p.48) mentions another form of body ornamentation, the blackening of teeth, evidently widespread in Melanesia as far east as the Solomons. [Seligman](Source#cldf:Seligman1910) ([1910](Source#cldf:Seligman1910):492) describes the custom among the people of Tubetube (PT), in which fragments of a black bituminous semi-fossilised wood called _tari_ are mixed into a paste with the chopped and roasted leaves of the badira tree, and held against the teeth overnight. He gives the purpose of teeth blackening as 'a means of personal adornment and to attract the opposite sex'. A reconstructed form, _&ast;tapal_, can be made for PWOc (the Sa'a term, _taha_ rather than the expected _aha_, has to be considered a borrowing). [Mikloucho-Maclay](Source#cldf:MiklouchoMaclay1975) ([1975](Source#cldf:MiklouchoMaclay1975):89) recorded in 1871 that "The natives [of Astrolabe Bay] not only blacken their faces, but also the mouth (tongue, teeth, gums, lips) with a substance which they chew." He gives the name _taval_ for this substance. Although we cannot attribute _taval_ to a particular language (Mikloucho-Maclay lived in a village of Papuan speakers), it is evidence that reflexes of _&ast;tapal_ occur in the NNG area.

[PWOc &ast;_tapal_](cognatesetreferences.csv#cldf:1-4-5-3-101-PWOc-tapal-a)

A second reconstruction is PSS _&ast;ogo_ 'tooth-blackening powder' (Lau _ago_, Kwaio _ogo_). [Ivens](Source#cldf:Ivens1927) ([1927](Source#cldf:Ivens1927) (reissued 1972):83) described the custom as practised by 'young men or girls, who wish to give themselves airs', although later, (1930: 121) he wrote that "it was said to preserve the teeth and prevent sore gums".
...
[Chowning](Source#cldf:Chowning1991) ([1991](Source#cldf:Chowning1991): 48) points out that tattooing in New Guinea has only limited distribution, tending to be confined to people with relatively light skin. "Where it was practised, methods ranged from the cutting of fine lines with obsidian, after which pigment was rubbed in, to the use of special implements. Darker-skinned people practised ornamental cicatrisation." Although no POc reconstruction has been made for the activity, reflexes of POc _&ast;saRum_ (see [§3.2.1](ContributionTable?anchor=s-3-2-1#cldf:1-4)) indicate that a tattooing needle of bat's bone was known in both eastern and western Oceanic as well as the Admiralties. In the east Oceanic region tattooing is widespread. It was practised most extensively and reached its highest artistic development in Polynesia. A needle of bat or bird bone was tapped repetitively with a mallet, and a dye, probably of vegetable origin, rubbed into the punctured area. (Maoris used a dye made from the oily smoke of burning nut kernels. In Bellona the sap of the _ŋieemuŋii_ tree—_Canarium harveyi_—was collected, allowed to set, burnt and the carbon collected and scraped into a black powder ([Tickle 1977](Source#cldf:Tickle1977): 11)). A group of Samoic Outliers (Anuta, Luangiua, Takuu, Tikopia) use reflexes of PPn _&ast;matau_ 'axe' to refer to their tattooing chisel.
...
[PPn &ast;_tatau_](cognatesetreferences.csv#cldf:1-4-5-4-102-PPn-tatau-a)

A different term for tattooing is reflected in some Southeast Solomonic and Micronesian languages.

[PEOc &ast;_make_](cognatesetreferences.csv#cldf:1-4-5-4-102-PEOc-make-a)
...
[Ross](Source#cldf:Ross1996c) ([1996c](Source#cldf:Ross1996c)) has reconstructed a verb, _&ast;noŋo_ 'decorate', used with reference to putting patterns onto pots and other articles, and for tattooing, but his supporting data are limited to three reflexes, and the reconstruction must be deemed tentative.

[POc &ast;_noŋo_](cognatesetreferences.csv#cldf:1-4-5-4-102-POc-noo-a)
...
[POc &ast;_mʷati_](cognatesetreferences.csv#cldf:1-4-5-4-102-POc-mati-a)
...
[Chowning](Source#cldf:Chowning1991) ([1991](Source#cldf:Chowning1991): 47) describes the situation in the New Guinea area:
...
[POc &ast;_bara_](cognatesetreferences.csv#cldf:1-4-5-5-103-POc-bara-a)

<a id="fig-1-13"> </a>

[__Figure 13:__ POc _&ast;bara_ 'plaited cane armlet' (from Nevermann_1934: 151)](MediaTable#cldf:fig-1-13)



[Spriggs](Source#cldf:Spriggs1997a) ([1997a](Source#cldf:Spriggs1997a): 88) lists the distinctive range of shell ornaments recovered from Lapita sites such as Eloaua in the Admiralties, Balof (New Ireland) and Arawe Islands south-west of New Britain. They include Conus shell rectangular units, beads, rings and disks, _Tridacna_ rings, Spondylus beads and long units and _Trochus_ armrings. Reconstructions have been possible for armlets, pearlshell ornaments, ear decorations and for the act of stringing together a necklace.

[POc &ast;_&#91;la&#93;lak&#91;o&#93;_](cognatesetreferences.csv#cldf:1-4-5-5-103-POc-lalako-a)
...
[POc &ast;_(sabi-)sabi_](cognatesetreferences.csv#cldf:1-4-5-5-104-POc-sabisabi-a)


<a id="p-105"></a>

[PCP &ast;_sau_](cognatesetreferences.csv#cldf:1-4-5-5-105-PCP-sau-a)
...
[PAn &ast;_CuSuR_](cognatesetreferences.csv#cldf:1-4-5-5-105-POc-turi-a)
...
[__Figure 14:__ POc _&ast;saRu_ 'comb'](MediaTable#cldf:fig-1-14)
...
[PMP &ast;_saRu_](cognatesetreferences.csv#cldf:1-4-5-5-105-POc-saru-a)


<a id="p-106"></a>

Blust reconstructs PMP _&ast;suat_ 'k.o. comb', a root which seems to have survived as a transitive verb in POc.

[PMP &ast;_suat_](cognatesetreferences.csv#cldf:1-4-5-5-106-POc-suwat-a)
...
These fall into two main categories, a) wind instruments, and b) drums. Apart from the conch shell trumpet, the wind instruments recorded in the ethnographic literature are usually of bamboo, although [Blackwood](Source#cldf:Blackwood1935) ([1935](Source#cldf:Blackwood1935): 413) describes a didgeridoo-type instrument, the _mabu_, used on Buka, which is made from the trunk of a small tree. Bamboo instruments are often simply referred to by the term for bamboo. The drums are typically wooden; but occasionally lighter drums are made from larger varieties of bamboo. Where a skin head is required, as in the hourglass drums, the skin of the monitor lizard is used where available. In Polynesia (Rarotonga), sharkskin has been recorded as a drum skin.
...
[PMP &ast;_tambuRi(q)_](cognatesetreferences.csv#cldf:1-4-6-1-106-POc-tapuriq-a)
...
[__Figure 15:__ POc _&ast;tapuRi(q)_ 'triton shell trumpet' (from Nevermann_1933:218) POc _&ast;kauR_ 'bamboo wind instrument'](MediaTable#cldf:fig-1-15)
...
[POc &ast;_upi_](cognatesetreferences.csv#cldf:1-4-6-2-107-POc-upi-a)


<a id="p-108"></a>

[PAn &ast;_qauR_](cognatesetreferences.csv#cldf:1-4-6-2-108-POc-kaur-a)

[POc &ast;_kopi_](cognatesetreferences.csv#cldf:1-4-6-2-108-POc-kopi-a)
...
This relatively small drum, easily carried, is of wood, with the end covered in (lizard) skin. [Chowning](Source#cldf:Chowning1991) ([1991](Source#cldf:Chowning1991): 59) has noted that on the north coast of New Guinea and in some parts of west New Britain the name for the instrument is suspiciously close to the word for 'monitor lizard' (Sengseng _pahiyo_ 'drum', _apahiya_ 'lizard'). Drumming is produced with the hand, and typically accompanies dances. [Ivens](Source#cldf:Ivens1927) ([1927](Source#cldf:Ivens1927) (reissued 1972): 169) reports that "a true drum of wood with skin stretched over it, such as is used in New Guinea and Torres Straits, is not found on Mala [Malaita] and Ulawa".

<a id="fig-1-16"> </a>

[__Figure 16:__ POc _&ast;kude_ 'hourglass drum'](MediaTable#cldf:fig-1-16)



[POc &ast;_kude_](cognatesetreferences.csv#cldf:1-4-6-3-109-POc-kude-a)

The alternation in gloss between the two kinds of drum is probably due to the term for one kind being used also as a generic. [Chowning](Source#cldf:Chowning1991) ([1991](Source#cldf:Chowning1991): 60) reports that in Kove _kure_ can be used for either instrument, although there is a separate term for slitgong.
...
[POc &ast;_garamut_](cognatesetreferences.csv#cldf:1-4-6-4-109-POc-garamut-a)


<a id="p-110"></a>

[PSS &ast;_ɣoɣo_](cognatesetreferences.csv#cldf:1-4-6-4-110-PSS-oo-a)

[PCP &ast;_lali_](cognatesetreferences.csv#cldf:1-4-6-4-110-PCP-lali-a)

[PCP &ast;_(v,b)asu_](cognatesetreferences.csv#cldf:1-4-6-4-110-PCP-vbasu-a)

[PPn &ast;_nafa_](cognatesetreferences.csv#cldf:1-4-6-4-110-PPn-nafa-a)
...
[PWOc &ast;_bogo-bogo_](cognatesetreferences.csv#cldf:1-4-6-5-110-PWOc-bogobogo-a)
...
[POc &ast;_sapu(r)_](cognatesetreferences.csv#cldf:1-4-7-1-111-POc-sapur-a)

<a id="fig-1-17"> </a>

[__Figure 17:__ POc _&ast;salap_ 'broom'](MediaTable#cldf:fig-1-17)



[POc &ast;_tapi_](cognatesetreferences.csv#cldf:1-4-7-1-111-POc-tapi-a)

[POc &ast;_salap_](cognatesetreferences.csv#cldf:1-4-7-1-111-POc-salap-a)
...
[PMP &ast;_qulun-an_](cognatesetreferences.csv#cldf:1-4-7-2-112-POc-quluan-a)
...
[__Figure 18:__ POc _&ast;quluŋ-an_ 'wooden headrest' (from Nevermann_1934:271)](MediaTable#cldf:fig-1-18)



[POc &ast;_kalik_](cognatesetreferences.csv#cldf:1-4-7-2-113-POc-kalik-a)
...
[^2]: For a fuller account of POc pottery manufacture, see [Ross](Source#cldf:Ross1996c) ([1996c](Source#cldf:Ross1996c)).
...
[^4]:  [Oliver](Source#cldf:Oliver1974) ([1974](Source#cldf:Oliver1974): 139) describes cord making from "the flax-like _piripiri_ (Cenchrus echinatus)" in Tahiti, quoting from Hendy (1927).

[^5]:   Takia _-l-_ is the lenis reflex of POc _&ast;-t-_.
...
[^7]:   Kooijman quotes from a report by William Mariner, a young Englishman stranded in Tonga from 1806-1810, indicating that at that time the term _tapa_ was used as well as the more general term _ŋatu_, the former referring to any bark-cloth "not printed or stained" ([Mariner 1827](Source#cldf:Mariner1827), [vol.2,206](ContributionTable?anchor=p-206#cldf:2-7)).

[^8]:   Kennedy identified terms as 'Toradja' in central Sulawesi. This is now recognised as a group of around a dozen related languages. The term _ike_ 'barkcloth beater' exists in at least one of them, Uma. Thanks are due to Phil Quick for locating relevant texts.
...
[^10]: Cf. POc _&ast;ubi_/_&ast;ibu_ 'half coconut shell used as drinking cup' ([§2.2.2](ContributionTable?anchor=s-2-2-2#cldf:1-4)). It is possible that both _&ast;ubi_/_&ast;ibu_ and _&ast;upi_/_&ast;ipu_ were generated at the same time by the application of a single rule (or similar wordplay) to the pre-existing member of each pair.

[^11]: See [Ross](Source#cldf:Ross1996c) ([1996c](Source#cldf:Ross1996c)) for more detail of these processes.