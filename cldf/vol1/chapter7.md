...
[Andrew Pawley and Medina Pawley]{.smallcaps}
...
In his _Sailing Craft of Indonesia_ Adrian [Horridge](Source#cldf:Horridge1986) ([1986](Source#cldf:Horridge1986):2-3) employs a distributional argument when he writes:
...
A problem arises when students of comparative technology dabble in comparative linguistics without underpinning them by the careful studies of sound correspondences and subgroupings needed to distinguish between cognates, accidental resemblances and borrowings or to determine the relative chronology of linguistic innovations. The results of such dabblings will be largely worthless. Haddon and Hornell's ([Haddon 1937](Source#cldf:Haddon1937), [Haddon & Hornell 1938](Source#cldf:HaddonHornell1938), [Hornell 1936](Source#cldf:Hornell1936)) admirable survey, _Canoes of Oceania_, is marred by a number of fanciful historical speculations which rest in part on naive readings of linguistic similarities. To a much larger extent, however, their fanciful historical inferences rest on a diffusionist interpretation of the comparative material culture, uninformed by systematic study of comparative vocabulary or by archaeological evidence.
...
Many previous publications isolate Austronesian cognate sets referring to canoe parts and seafaring. However, works compiled by linguists only list such cognate sets as isolated items within a larger body of semantically unordered material. This chapter draws together published comparisons and extends them. Sources giving relevant cognate sets or sound correspondences relevant to determining cognation include [Bender et al.](Source#cldf:Benderetal1983) ([1983](Source#cldf:Benderetal1983)), [Biggs](Source#cldf:Biggs1978) ([1978](Source#cldf:Biggs1978), 1993),[^6]: [Blust](Source#cldf:Blust1970) ([1970](Source#cldf:Blust1970), [1972b](Source#cldf:Blust1972b), [1976a](Source#cldf:Blust1976a), [1978a](Source#cldf:Blust1978a), [1978b](Source#cldf:Blust1978b), [1980b](Source#cldf:Blust1980b), [1983–84a](Source#cldf:Blust198384a), [1986](Source#cldf:Blust1986), [1989](Source#cldf:Blust1989)), [Clark](Source#cldf:Clark1994) ([1994](Source#cldf:Clark1994)), [Collins](Source#cldf:Collins1983) ([1983](Source#cldf:Collins1983)), [Dahl](Source#cldf:Dahl1973) ([1973](Source#cldf:Dahl1973)), [Dempwolff](Source#cldf:Dempwolff1938) ([1938](Source#cldf:Dempwolff1938)), [Ferrell](Source#cldf:Ferrell1969) ([1969](Source#cldf:Ferrell1969)), [Geraghty](Source#cldf:Geraghty1983) ([1983](Source#cldf:Geraghty1983)), [Jackson](Source#cldf:Jackson1983) ([1983](Source#cldf:Jackson1983)), [Milke](Source#cldf:Milke1961) ([1961](Source#cldf:Milke1961), [1968](Source#cldf:Milke1968)), [Pallesen](Source#cldf:Pallesen1985) ([1985](Source#cldf:Pallesen1985)), [Pawley](Source#cldf:Pawley1972) ([1972](Source#cldf:Pawley1972)), [Reid](Source#cldf:Reid1971) ([1971](Source#cldf:Reid1971)), [Ross](Source#cldf:Ross1988) ([1988](Source#cldf:Ross1988)), [Sneddon](Source#cldf:Sneddon1984) ([1984](Source#cldf:Sneddon1984)) and [Tryon](Source#cldf:Tryon1976) ([1976](Source#cldf:Tryon1976)). We have also consulted dictionaries of many contemporary languages.
...
[POc &ast;_tola_](cognatesetreferences.csv#cldf:1-7-2-1-181-POc-tola-a)

Evidence for the reconstruction occurs in two geographically separated primary subgroups of Oceanic, but apparently nowhere else. Despite this distribution, the evidence would be clear enough, were it not for (i) the meaning of the PSES term, reconstructable as 'plank-built canoe', and (ii) the fact that the Lau, Baegu, Kwai and Arosi reflexes could well reflect, not _&ast;tola_, but POc _&ast;(q)oRa_ 'strake, probably topstrake (washstrake) ([§2.4](ContributionTable?anchor=s-2-4#cldf:1-7)) (Cristobal-Malaitan languages regularly lose POc _&ast;t_). It is possible that the forms _ola_/_ora_ reflect a falling together of _&ast;tola_ and _&ast;(q)oRa_, the meaning narrowing in favour of _&ast;(q)oRa_ and then transferred to Bugotu, Gela _tola_.
...
[PWMP &ast;_padaw_](cognatesetreferences.csv#cldf:1-7-2-2-183-PWMP-padaw-a)

[PWMP &ast;_paraSu_](cognatesetreferences.csv#cldf:1-7-2-2-183-PWMP-parasu-a)


<a id="p-184"></a>

These forms have sometimes been compared with Oceanic forms represented by Tongan _folau_ 'voyage, travel by sea', Fijian _volau_ 'boat shed' (cf. _&ast;pa-laSud_, [§9.2](ContributionTable?anchor=s-9-2#cldf:1-7)).

A PPn reconstruction for a small canoe used close to shore is well supported:

[PPn &ast;_paopao_](cognatesetreferences.csv#cldf:1-7-2-2-184-PPn-paopao-a)
...
[Blust](Source#cldf:Blust1986) ([1986](Source#cldf:Blust1986):33) reconstructs the term _&ast;dakit_, noting a number of reflexes within the WMP region and a regular reflex in one Oceanic language, Motu. To these may be added many other Philippine and Northern Sulawesi reflexes (given in [Reid 1971](Source#cldf:Reid1971)) and possible reflexes in CMP and Western Oceanic.

[PMP &ast;_dakit_](cognatesetreferences.csv#cldf:1-7-2-2-184-POc-rakit-a)

[Chowning](Source#cldf:Chowning1985) ([1985](Source#cldf:Chowning1985): 59) gives the following as possible cognates, although the final vowel is problematic:

[1-7-2-2-184-nng-kove-lae](cf.csv#cldf:1-7-2-2-184-nng-kove-lae)
...
The comparisons below and in [§2.5](ContributionTable?anchor=s-2-5#cldf:1-7) point to the use by speakers of PMP and its immediate descendants, of boats built up by planking and strengthened by thwarts:

[PMP &ast;_papan_](cognatesetreferences.csv#cldf:1-7-2-4-185-POc-baban-a)

PMP _&ast;papan_ evidently referred to any plank or board (see [Ch. 3, §3](ContributionTable?anchor=s-3#cldf:1-3). S). It might be argued that this term could have been independently applied to canoe strakes or planks by different daughter languages after the break-up of PMP. However, the fact that in diverse Malayo-Polynesian languages reflexes of _&ast;papan_ are consistently used of canoe planks, even in cases when another general word for plank or board has developed, is a fairly strong indication that this application goes back to PMP times.


<a id="p-186"></a>

[POc &ast;_(q)oRa_](cognatesetreferences.csv#cldf:1-7-2-4-186-POc-qora-a)

Possible cognates of _&ast;(q)oRa_ occur in Cristobal-Malaitan languages of the Southeast Solomonic family: Arosi _ora_, Lau _ola_ 'plank-built canoe (built up from a plank centre keel, with bow and stern keels), with no outrigger'. As noted in [§2.1](ContributionTable?anchor=s-2-1#cldf:1-7), however, their interpretation is difficult, as they could also reflect POc _&ast;tola_ 'large canoe'.

The question of how planks were joined is connected to the question of whether early Austronesian communities used stone or metal tools, as the following remarks by [Scott](Source#cldf:Scott1982) ([1982](Source#cldf:Scott1982):338-339) make clear:
...
We can reconstruct PMP _&ast;kiRam_ 'adze/axe' and _&ast;taRaqi_ (V) 'adze, carve' ([Ch. 4, §4.1.1](ContributionTable?anchor=s-4-1-1#cldf:1-4)), with reflexes in Oceanic as well as in WMP witnesses, but there are no secure PMP or POc reconstructions for other equipment likely to have been used in boat-building.[^11]: The current consensus among archaeologists is that the introduction of metal in eastern Asia postdated the break-up of PAn and PMP. Although [Blust](Source#cldf:Blust1976b) ([1976b](Source#cldf:Blust1976b)) has pointed to comparisons between Formosan and WMP forms suggesting that PAn speakers may have had a knowledge of metal tools, it is likely that this knowledge spread after the break-up of PAn and PMP.
...
[PMP &ast;_seŋkar_](cognatesetreferences.csv#cldf:1-7-2-5-187-POc-sokar-a)
...
There is no well-supported PMP reconstruction for 'dugout underbody of canoe (to which planking is added)' or for 'keel of built-up canoe' although _&ast;ba(ŋ)ka(q)_ ([§2.1](ContributionTable?anchor=s-2-1#cldf:1-7)) is a candidate for the former. Such a term is, however, clearly reconstructable for PCP:

[PCP &ast;_takele_](cognatesetreferences.csv#cldf:1-7-2-6-187-PCP-takele-a)
...
[PPn &ast;_liu_](cognatesetreferences.csv#cldf:1-7-2-7-188-PPn-liu-a)
...
[POc &ast;_muri-_](cognatesetreferences.csv#cldf:1-7-2-8-188-POc-muri-a)

See also PPn _&ast;tau-muri_ 'afterdeck' ([§2.10](ContributionTable?anchor=s-2-10#cldf:1-7))

[POc &ast;_muqa-_](cognatesetreferences.csv#cldf:1-7-2-8-188-POc-muqa-a)

See also PPn _&ast;tau-mu ʔa_ 'foredeck ' ([§2.10](ContributionTable?anchor=s-2-10#cldf:1-7)).
...
[PCP &ast;_tau_](cognatesetreferences.csv#cldf:1-7-2-10-190-PCP-tau-a)
...
[PMP &ast;_pa(n)tar_](cognatesetreferences.csv#cldf:1-7-3-1-190-POc-patar-a)
...
A deck hut is often added to large outrigger canoes but no widespread cognate set distinctively denoting such a structure has so far been noted. In a number of languages, reflexes of PMP _&ast;balay_, POc _&ast;pale_ 'hut, shed, open-sided house' ([Ch. 3, §3.3](ContributionTable?anchor=s-3-3#cldf:1-3)) are used for a deck hut, for example, Fijian _vale waqa_ (lit. 'canoe house'), and _valevale_ 'hut' ([Hornell 1936](Source#cldf:Hornell1936):323), and this may also have been the case in POc.
...
The meaning 'outrigger float' can be attributed to PMP _&ast;(c,s)a(R)man_. This term is well attested in Oceanic and Central/Eastern Malayo-Polynesian, but rare in WMP. In many WMP languages it has been replaced in this meaning by a reflex of _&ast;katiR_ ([§2.1](ContributionTable?anchor=s-2-1#cldf:1-7)). In Oceanic languages the reflex of POc _&ast;saman_ also has the sense of 'outrigger side of the canoe' in contrast to _&ast;katae_ 'free side of canoe' ([§4.4](ContributionTable?anchor=s-4-4#cldf:1-7)).

[PMP &ast;_(c,s)a(R)man_](cognatesetreferences.csv#cldf:1-7-4-1-191-POc-saman-a)
...
[POc &ast;_kiajo_](cognatesetreferences.csv#cldf:1-7-4-2-192-POc-kiajo-a)

Fijian _i-kaso_ 'outrigger boom' (zero for _&ast;i_ irregular) has sometimes been included in this set, but probably belongs to a separate set, along with such forms as Mota _gaso_ 'rafter', Lau _ʔato_ 'rafter', which derive from a well-established etymon PMP _&ast;kasaw_, POc _&ast;kaso_ 'rafter' ([Ch. 3, §3.4](ContributionTable?anchor=s-3-4#cldf:1-3)). However, the comparison with Lau _ato_ 'outrigger boom' suggests that POc _&ast;kaso_ probably had the general meaning 'connecting beam or brace', and as well as denoting crossbeams in a house may have been used as a synonym of _&ast;kiajo_.
...
A POc reconstruction for the connective sticks (stanchions, struts) was made by [Milke](Source#cldf:Milke1968) ([1968](Source#cldf:Milke1968)) and is well attested. A single cognate in the north-west New Guinea language, Numfor, allows tentative attribution of this etymon (with indeterminate final vowel) to Proto Eastern Malayo-Polynesian.

[PEMP &ast;_patotV_](cognatesetreferences.csv#cldf:1-7-4-3-193-POc-patoto-a)
...
[POc &ast;_katae_](cognatesetreferences.csv#cldf:1-7-4-4-193-POc-katae-a)
...
We give here a further quote from [Horridge](Source#cldf:Horridge1986) ([1986](Source#cldf:Horridge1986):56-57):
...
[PMP &ast;_layaR_](cognatesetreferences.csv#cldf:1-7-5-1-194-POc-layar-a)

Traditional Oceanic sails are made of matting, woven from pandanus leaves or other plant fibres. It is therefore not surprising to find that reflexes of POc _&ast;qebal_ 'pandanus mat' also have the meaning 'sail' in a few languages. Given that POc _&ast;layaR_ 'sail' is well established, it is likely that _&ast;qebal_ independently acquired the sense 'sail' in more than one daughter language. For the cognate set, see [Ch. 4, §3.1](ContributionTable?anchor=s-3-1#cldf:1-4).
...
[PEOc &ast;_kaiu-tuqu(r)_](cognatesetreferences.csv#cldf:1-7-5-3-196-PEOc-kaiutuqur-a)
...
[PCP &ast;_tuku_](cognatesetreferences.csv#cldf:1-7-5-4-197-PCP-tuku-a)
...
[PMP &ast;_quli(n,ŋ)_](cognatesetreferences.csv#cldf:1-7-6-None-197-POc-quli-a)
...
[PMP &ast;_be(R)(c,s)ay_](cognatesetreferences.csv#cldf:1-7-7-2-198-POc-pose-a)


<a id="p-199"></a>

[PMP &ast;_pa-luja_](cognatesetreferences.csv#cldf:1-7-7-2-199-POc-paluca-a)
...
[POc &ast;_tokon_](cognatesetreferences.csv#cldf:1-7-7-3-200-POc-tokon-a)
...
[PMP &ast;_limas_](cognatesetreferences.csv#cldf:1-7-7-4-201-POc-limas-a)

<a id="fig-1-26"> </a>

[__Figure 26:__ POc _&ast;lima(s)_ or _&ast;nima(s)_, POc _&ast;asu_ 'bailer'](MediaTable#cldf:fig-1-26)



The following PMP reconstruction is given by [Blust](Source#cldf:Blust1978b) ([1978b](Source#cldf:Blust1978b): 94). Although 'scoop or ladle out' was probably the basic meaning, a number of Oceanic languages use the reflex of _&ast;asu_ to denote a bailer.

[PMP &ast;_aŋsu_](cognatesetreferences.csv#cldf:1-7-7-4-201-POc-asu-a)
...
[PPn &ast;_tatā_](cognatesetreferences.csv#cldf:1-7-7-4-202-PPn-tata-a)
...
[PCP &ast;_tā-dravu_](cognatesetreferences.csv#cldf:1-7-7-5-202-PCP-tadravu-a)

The PCP form can be analysed into two elements: the second is clearly _&ast;dravu_ 'fireplace, hearth', which reflects POc _&ast;rapu(R)_ 'hearth, fireplace; ashes' ([Ch. 6, §2.4](ContributionTable?anchor=s-2-4#cldf:1-6)). The origin of _&ast;tā_ is less clear.
...
[PMP &ast;_laŋen_](cognatesetreferences.csv#cldf:1-7-8-1-203-POc-laon-a)
...
[PMP &ast;_sauq_](cognatesetreferences.csv#cldf:1-7-8-2-203-POc-jauq-a)
...
The PMP and POc term _&ast;sawaŋ_ or _&ast;sawaq_ appears to have been the conventional name for a channel for boats to pass through or to land, or an area of calm water giving safe anchorage. [Blust](Source#cldf:Blust198384a) ([1983–84a](Source#cldf:Blust198384a): 113) reconstructs _&ast;sawaq_ 'channel'.

[PMP &ast;_sawa(ŋ,q)_](cognatesetreferences.csv#cldf:1-7-8-3-204-POc-sawa-a)

There is clear evidence for a POc compound consisting of _&ast;mata_ 'opening, entrance; focal point' plus _&ast;sawaŋ_, with the sense 'landing place for boats'. The Southeast Solomonic and Kiribatese forms suggest the POc compound had the form _&ast;mata-ni-sawaŋ_, or _&ast;mata-qi-sawaŋ_, with one of the two POc genitive particles _&ast;ni_ or _&ast;qi_ ([Hooper 1985](Source#cldf:Hooper1985)) linking the two nouns. However, the Admiralty Islands and Fijian forms do not reflect the genitive.

[POc &ast;_mata-sawaŋ_](cognatesetreferences.csv#cldf:1-7-8-3-204-POc-matasawa-a)
...
While boatsheds, for building and sheltering boats, are common in the Malayo-Polynesian speaking region, no really widespread cognate set for such a building has been noted outside the Central Pacific group. Some Oceanic languages use a simple term reflecting PMP _&ast;balay_ 'house or building, probably with open sides' as Lou (Admiralties) _pal_ 'boatshed'. Others use a compound nominal whose components, as in English, are the words for 'boat' and 'house' . It may be that speakers of PMP used such a compound but it is hard to rule out the possibility of independent parallel developments in the daughter languages. However, there is good evidence for a distinctive PCP term for boatshed, evidently incorporating the term for 'make a sea voyage' (see POc _&ast;palau(r)_, [§9.2](ContributionTable?anchor=s-9-2#cldf:1-7)):

[PCP &ast;_(a)valau_](cognatesetreferences.csv#cldf:1-7-8-4-205-PCP-avalau-a)
...
[PMP &ast;_sakay_](cognatesetreferences.csv#cldf:1-7-9-1-205-POc-sake-a)
...
[PMP &ast;_pa-laSud_](cognatesetreferences.csv#cldf:1-7-9-2-206-POc-palaur-a)
...
[Blust](Source#cldf:Blust1978a) ([1978a](Source#cldf:Blust1978a):216) offers the following:

[PEMP &ast;_ta(d,R)i_](cognatesetreferences.csv#cldf:1-7-9-2-207-POc-tari-a)
...
[PMP &ast;_biluk_](cognatesetreferences.csv#cldf:1-7-9-2-207-POc-piluk-a)
...
[POc &ast;_tau (ni) waga_](cognatesetreferences.csv#cldf:1-7-9-4-208-POc-tauniwaga-a)
...
[^2]: See e.g. [Shutler and Marck](Source#cldf:ShutlerMarck1975) ([1975](Source#cldf:ShutlerMarck1975)), [Bellwood](Source#cldf:Bellwood1978) ([1978](Source#cldf:Bellwood1978), [1988](Source#cldf:Bellwood1988)), [Pawley and Green](Source#cldf:PawleyandGreen1973) ([1973](Source#cldf:PawleyandGreen1973), [1984](Source#cldf:PawleyandGreen1984)), [Spriggs](Source#cldf:Spriggs1984) ([1984](Source#cldf:Spriggs1984), [1989](Source#cldf:Spriggs1989), [1990](Source#cldf:Spriggs1990)) for discussion of the dating of the Austronesian diaspora, using C14 dating of archaeological assemblages that can be associated with Austronesian speakers.

[^3]:  Among the scores of 20th century works on these subjects are [Best](Source#cldf:Best1923) ([1923](Source#cldf:Best1923), [1925](Source#cldf:Best1925)), Doran (1981), [Finney](Source#cldf:Finney1979) ([1979](Source#cldf:Finney1979)), [Friederici](Source#cldf:Friederici1933) ([1933](Source#cldf:Friederici1933)), [Gladwin](Source#cldf:Gladwin1970) ([1970](Source#cldf:Gladwin1970)), [Golson](Source#cldf:Golson1972) ([1972](Source#cldf:Golson1972)), [Haddon](Source#cldf:Haddon1937) ([1937](Source#cldf:Haddon1937)), [Haddon and Hornell](Source#cldf:HaddonHornell1938) ([1938](Source#cldf:HaddonHornell1938)), [Hornell](Source#cldf:Hornell1936) ([1936](Source#cldf:Hornell1936)), [Horridge](Source#cldf:Horridge1978) ([1978](Source#cldf:Horridge1978), [1981](Source#cldf:Horridge1981), [1986](Source#cldf:Horridge1986)), [Hutchins](Source#cldf:Hutchins1983) ([1983](Source#cldf:Hutchins1983)), [Irwin](Source#cldf:Irwin1989) ([1989](Source#cldf:Irwin1989), [1992](Source#cldf:Irwin1992)), [Lewis](Source#cldf:Lewis1972) ([1972](Source#cldf:Lewis1972)), [Sharp](Source#cldf:Sharp1956) ([1956](Source#cldf:Sharp1956)), [Siers](Source#cldf:Siers1977) ([1977](Source#cldf:Siers1977)), [Thomas](Source#cldf:Thomas1987) ([1987](Source#cldf:Thomas1987)).
...
[^6]:   The version of POLLEX (= [Biggs & Clark 1993](Source#cldf:BiggsandClark1993)) used here, in fact, dates from 1990.

[^7]:   Obsolete term, cited by [Ferrell](Source#cldf:Ferrell1969) ([1969](Source#cldf:Ferrell1969):42, 247); the only reported cognate in a Formosan witness.

[^8]: See [Pawley and Green](Source#cldf:PawleyandGreen1973) ([1973](Source#cldf:PawleyandGreen1973)), [Green](Source#cldf:Green1991b) ([1991b](Source#cldf:Green1991b)) for the terms 'Near Oceania' and 'Remote Oceania'.

[^9]: _b_ for expected _p_, possibly borrowed from a Polynesian source.

[^10]: Obsolete ([Hornell 1936](Source#cldf:Hornell1936):302).

[^11]:  The fruit of the putty nut (_Parinari_um laurinum) is widely used to caulk or stop a vessel. In Proto Huon Gulf an identical term is reconstructable both for the nut and the glue that is made from it: Proto Huon Gulf _&ast;jimiR_ 'putty nut, caulking substance' ([Ross 1988](Source#cldf:Ross1988):79); Tami _jim_ 'caulking substance'; Tuam _zimir_ 'caulk'; Numbami _dimil-a_ 'caulk'. The following set is of uncertain relation to _&ast;jimiR_: POc _&ast;jema_ 'caulk' ([Milke 1968](Source#cldf:Milke1968)): Motu _dema-ia_ 'caulk'; E. Fijian _sema_ 'splice, join, patch', _sema-ta_ 'to splice, join, patch s.t.'
...
[^15]: See [Pawley](Source#cldf:Pawley1973) ([1973](Source#cldf:Pawley1973): 172).
...
[^17]: According to [Best](Source#cldf:Best1925) ([1925](Source#cldf:Best1925): 183), the term _ra kautu_ [=_raa kautuu_] refers to a (triangular) sail with mast that is stepped upright in a cupped boss on the floor of the dugout.