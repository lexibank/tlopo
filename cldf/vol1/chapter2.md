...
c) PMP and a number of its descendants had word-medial homorganic nasal + obstruent
   sequences (not in [Table 1](#tab-1)). Some instances of the pre-POc word-initial obstruents _&ast;p_, _&ast;t_,
...
We can reconstruct three major classes of POc intransitive verb on the basis of semantic and morphological criteria, as shown in [Table 2](#tab-2).
