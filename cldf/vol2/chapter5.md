...
The reconstruction of any terminology brings its own peculiar problems. In this case, the challenge was associated with the fact that meteorological conditions are not the same throughout the Austronesian speaking area. It is a necessary inference that as Austronesian speakers settled the regions they now occupy, they encountered new conditions which required adaptations in their terminology. Thus the meanings of the terms in a given language need to be related to the weather conditions which occur where the language is spoken. For this reason, [§2](ContributionTable?anchor=s-2#cldf:2-5) gives a short account of Pacific wind systems, while in [§3](ContributionTable?anchor=s-3#cldf:2-5) the weather patterns that Austronesian speakers encountered during their (largely eastward) migrations are described. Less trivially, a hypothesis about the semantic structure of POc speakers’ weather terminology must rest on a hypothesis about where POc was spoken — and the same is true of any protolanguage for which weather terms are reconstructed. My assumption here that POc was spoken in the Bismarck Archipelago. I return to this matter in the concluding section.[^1]:
...
[__Map 10:__ Prevailing winds in the Indian and Pacific Oceans during the southern hemisphere winter (July)](MediaTable#cldf:map-2-10)
...
[__Map 11:__ Prevailing winds in the Indian and Pacific Oceans during the southern hemisphere summer (January)](MediaTable#cldf:map-2-11)
...
The trade winds and the ITCZ are two of the major ingredients of the weather in the region inhabited by Austronesian speakers. [Map 10](#map-2-10) provides a general overview for the period from (roughly) April to October.[^2]:
...
Even in the equatorial zone, there is some seasonal variation in rainfall, the peak occurring in the SHS when the airflow is from Asia to Australia. This difference became more pronounced the further south and east (i.e. the closer to Australia) Austronesian speakers moved, and Sumba and Timor are quite dry during the SHW when the easterly monsoon brings dry air from Australia. By the time it reaches western Indonesia or moves north of the Equator and becomes the southwest monsoon, its winds have become humid and a source of rain, so that Sumatra and Borneo have no dry season, whilst Java divides into a wet west (from orographic rain) and a dry east ([McDivitt 1984](Source#cldf:Mcdivitt1984)).
...
[PMP &ast;_haŋin_](cognatesetreferences.csv#cldf:2-5-4-1-126-POc-ain-a)
...
[POc &ast;_jaŋi_](cognatesetreferences.csv#cldf:2-5-4-1-127-POc-jai-a)

[POc &ast;_sau_](cognatesetreferences.csv#cldf:2-5-4-1-127-POc-sau-a)

[POc &ast;_mur&#91;i,e&#93;_](cognatesetreferences.csv#cldf:2-5-4-1-127-POc-murie-a)

The terms below may also reflect POc _&ast;mur[i,e]_, but with a change in meaning.

[2-5-4-1-127-nng-amara-omur](cf.csv#cldf:2-5-4-1-127-nng-amara-omur)
...
[POc &ast;_mal(i,e)u_](cognatesetreferences.csv#cldf:2-5-4-1-128-POc-malieu-a)

In [Ross](Source#cldf:Ross1995c) ([1995c](Source#cldf:Ross1995c)) I wrote:
...
[POc &ast;_i(p,pʷ)i_](cognatesetreferences.csv#cldf:2-5-4-1-130-POc-ippi-a)

Two other forms meaning ‘blow’ are also reconstructable. These are also formally rather similar to each other, but this similarity evidently dates back to well before the genesis of POc. I know of no proper non-Oceanic cognates of POc _&ast;(p,pʷ)usi_, but it appears to reflect the same monosyllabic root (_&ast;bus_) as PMP _&ast;qembus_ ‘snort, pant’ (ACD) (with regard to monosyllabic roots, see [vol.1,27](ContributionTable?anchor=p-27#cldf:1-2)–28).

[POc &ast;_(p,pʷ)usi_](cognatesetreferences.csv#cldf:2-5-4-1-130-POc-ppusi-a)
...
[PAn &ast;_pu+put_](cognatesetreferences.csv#cldf:2-5-4-1-131-POc-puput-a)
...
[POc &ast;_raki_](cognatesetreferences.csv#cldf:2-5-4-2-132-POc-raki-a)

Much of the data for the reconstruction of PPn wind directions is drawn from [Biggs and Clark](Source#cldf:BiggsandClark1993) ([1993](Source#cldf:BiggsandClark1993)), but the glosses of the protoforms are mine. For example, for PPn _&ast;laki_ Biggs and Clark give the gloss ‘the westerly quarter, wind from that quarter and weather associated with it’. If this were its denotation, we might expect reflexes to range in meaning between northwest and southwest, but no reflex denotes a direction north of west. From this I infer that it denoted the southwesterly quadrant. Similar argumentation applies to PPn _&ast;toŋa_ ‘southeasterly quadrant, southeast wind’ and PPn _&ast;tokelau_ ‘northwesterly quadrant, north-west winds’ below.
...
[PAn &ast;_SabaRat_](cognatesetreferences.csv#cldf:2-5-4-2-133-PAn-sabarat-a)
...
[PMP &ast;_habaRat_](cognatesetreferences.csv#cldf:2-5-4-2-133-POc-aparat-a)
...
[2-5-4-2-135-ses-arosi-worosi](cf.csv#cldf:2-5-4-2-135-ses-arosi-worosi)
...
[POc &ast;_tokalau(r)_](cognatesetreferences.csv#cldf:2-5-4-2-137-POc-tokalaur-a)

POc _&ast;tokalau(r)_ ‘(?) northerly wind’ reflects two PMP morphemes, as [Dempwolff](Source#cldf:Dempwolff1938) ([1938](Source#cldf:Dempwolff1938):134) observed. The first appears to be PMP _&ast;tekas_ ‘come to rest in a place’ (ACD), the second PMP _&ast;lahud_ ‘downriver, towards the sea’. It is not clear how the POc meaning is derived from the glosses of these morphemes, and probable that POc _&ast;toka-lau(r)_ was a lexicalised unit.
...
[2-5-4-2-138-mm-roviana-toarauru](cf.csv#cldf:2-5-4-2-138-mm-roviana-toarauru)
...
[POc &ast;_karak(a)_](cognatesetreferences.csv#cldf:2-5-4-2-138-POc-karaka-a)
...
[POc &ast;_marau_](cognatesetreferences.csv#cldf:2-5-4-2-139-POc-marau-a)

[PNGOc &ast;_yawana_](cognatesetreferences.csv#cldf:2-5-4-2-139-PNGOc-yawana-a)
...
[POc &ast;_aqura_](cognatesetreferences.csv#cldf:2-5-4-2-139-POc-aqura-a)
...
[2-5-4-2-140-nng-kove-hai](cf.csv#cldf:2-5-4-2-140-nng-kove-hai)

— whilst the two below reflect POc _&ast;apaRat_ ‘northwest wind’:

[2-5-4-2-140-mm-barok-awat](cf.csv#cldf:2-5-4-2-140-mm-barok-awat)
...
[PMP &ast;_linaw_](cognatesetreferences.csv#cldf:2-5-5-None-140-POc-malino-a)


<a id="p-141"></a>

[PMP &ast;_(d,r)apu_](cognatesetreferences.csv#cldf:2-5-5-None-141-POc-madmarapu-a)
...
[POc &ast;_ma-luas_](cognatesetreferences.csv#cldf:2-5-5-None-141-POc-maluas-a)
...
[PWOc &ast;_siwaRop_](cognatesetreferences.csv#cldf:2-5-5-None-141-PWOc-siwarop-a)
...
[PMP &ast;_laŋiC_](cognatesetreferences.csv#cldf:2-5-5-2-142-POc-lait-a)
...
[PNGOc &ast;_sabam_](cognatesetreferences.csv#cldf:2-5-5-2-143-PNGOc-sabam-a)

The generic term for ‘cloud’ in POc was _&ast;qaRoq_.

[POc &ast;_qaRoq_](cognatesetreferences.csv#cldf:2-5-5-2-143-POc-qaroq-a)
...
[PMP &ast;_rendeŋ_](cognatesetreferences.csv#cldf:2-5-5-2-143-POc-rodo-a)

[PNGOc &ast;_guba(r,R)_](cognatesetreferences.csv#cldf:2-5-5-2-143-PNGOc-gubarr-a)


<a id="p-144"></a>

[POc &ast;_ulu_](cognatesetreferences.csv#cldf:2-5-5-2-144-POc-ulu-a)

[POc &ast;_bala_](cognatesetreferences.csv#cldf:2-5-5-2-144-POc-bala-a)
...
[PMP &ast;_Ra(m)bun_](cognatesetreferences.csv#cldf:2-5-5-2-144-POc-rapun-a)
...
[POc &ast;_bʷa(p)o_](cognatesetreferences.csv#cldf:2-5-5-2-145-POc-bapo-a)

The items below—POc _&ast;kapu(t)_/_&ast;kopu_ ‘low cloud, mist, fog’ and POc _&ast;gapu(l)_ ‘mist’ — are intriguing because of their formal similarity to each other. It is eminently likely that _&ast;gapu(l)_ is derivationally related to _&ast;kapu(t)_. If we ignore their putative final consonants, the former appears to be derived from _&ast;N_ + _kapu_ (see [vol.1,29](ContributionTable?anchor=p-29#cldf:1-2)–30). But the final _&ast;-t_ of _&ast;kapu(t)_ is attested by non-Oceanic witnesses, the final _&ast;-l_ of _&ast;gapu(l)_ by its Minigir and Tolai reflexes, and I cannot see a way of resolving this conflict.

[PMP &ast;_kabut_](cognatesetreferences.csv#cldf:2-5-5-2-145-POc-kaput-a)

The Bali and Fijian forms below are problematic, as they reflect POc _&ast;kabu(t)_, not _&ast;kapu(t)_

[2-5-5-2-145-mm-vitu-abuabu](cf.csv#cldf:2-5-5-2-145-mm-vitu-abuabu)
...
[POc &ast;_kopu_](cognatesetreferences.csv#cldf:2-5-5-2-145-POc-kopu-a)


<a id="p-146"></a>

[POc &ast;_gapu(l)_](cognatesetreferences.csv#cldf:2-5-5-2-146-POc-gapul-a)

As if this were not already complicated enough, a further curiosity is the reconstruction of Proto Nuclear Polynesian _&ast;kapuqa_ ‘cloud’ ([Biggs & Clark 1993](Source#cldf:BiggsandClark1993)), which either entails the addition of _&ast;-qa_ to a reflex of POc _&ast;kapu(t)_ or _&ast;gapu(l)_ or is a derivative of the PPn verb _&ast;kaputi_ ‘cover over’.

[PNPn &ast;_kapuqa_](cognatesetreferences.csv#cldf:2-5-5-2-146-PNPn-kapuqa-a)
...
[PAn &ast;_quZaL_](cognatesetreferences.csv#cldf:2-5-5-3-146-POc-qusan-a)


<a id="p-147"></a>

[POc &ast;_&#91;ka&#93;dapuR_](cognatesetreferences.csv#cldf:2-5-5-3-147-POc-kadapur-a)

[PWOc &ast;_(rR)ugu_](cognatesetreferences.csv#cldf:2-5-5-3-147-PWOc-rrugu-a)
...
[POc &ast;_bata_](cognatesetreferences.csv#cldf:2-5-5-3-148-POc-bata-a)
...
[PMP &ast;_lamuR_](cognatesetreferences.csv#cldf:2-5-5-3-149-POc-lamur-a)
...
[PMP &ast;_guruq_](cognatesetreferences.csv#cldf:2-5-5-4-151-POc-kuru-a)

[PMP &ast;_guruq_](cognatesetreferences.csv#cldf:2-5-5-4-151-POc-guru-a)


<a id="p-152"></a>

[POc &ast;_guru-ŋ(a)_](cognatesetreferences.csv#cldf:2-5-5-4-152-POc-gurua-a)

[POc &ast;_pʷaraq_](cognatesetreferences.csv#cldf:2-5-5-4-152-POc-paraq-a)

[POc &ast;_para-ŋ(a)_](cognatesetreferences.csv#cldf:2-5-5-4-152-POc-paraa-a)
...
[^2]: This section is based on general information about wind systems culled from [Monkhouse](Source#cldf:Monkhouse1966) ([1966](Source#cldf:Monkhouse1966): Chs. 16 and 18), [Hare](Source#cldf:Hare1984) ([1984](Source#cldf:Hare1984)), [Lamb](Source#cldf:Lamb1984) ([1984](Source#cldf:Lamb1984)) and [Irwin](Source#cldf:Irwin1992) ([1992](Source#cldf:Irwin1992)) and on information about Pacific weather from [Howlett](Source#cldf:Howlett1967) ([1967](Source#cldf:Howlett1967):36–38), Brookfield with Hart (1971:5–13), [Cotter](Source#cldf:Cotter1984) ([1984](Source#cldf:Cotter1984)); [Gentilli](Source#cldf:Gentilli1984) ([1984](Source#cldf:Gentilli1984)), and the Atlas of the South Pacific (New Zealand Government Printing Office, 1986). One difficulty that I encountered in writing this short conspectus was that there is disagreement in the literature about the weather patterns at some Pacific locations.

[^3]: A geographer expert in this field would probably consider this definition an oversimplification, but it will suffice for present purposes ([Gentilli 1984](Source#cldf:Gentilli1984):389).

[^4]: As well as the sources indicated in the text, this section relied quite heavily on [Brookfield and Hart](Source#cldf:BrookfieldandHart1971) ([1971](Source#cldf:BrookfieldandHart1971)), [Gentilli](Source#cldf:Gentilli1984) ([1984](Source#cldf:Gentilli1984)), and the Atlas of the South Pacific (New Zealand Government Printing Office, 1986).
...
[^7]: [Blust](Source#cldf:Blust1993) ([1993](Source#cldf:Blust1993)) derives PCEMP _&ast;upi_ from PMP _&ast;hiup_ ‘blow’, and it is possible that the generation of pairs was triggered by the existence of similar forms with close meanings.

[^8]: [Tsuchida](Source#cldf:Tsuchida1976) ([1976](Source#cldf:Tsuchida1976)) reconstructs PAn _&ast;qamiS_ ‘north wind’. Philippine reflexes indicate that the locative suffix _&ast;-an_ had been appended in PMP, giving _&ast;qamíh-an_, reflected in Isneg _amiyān_ ‘monsoon wind’, Casiguran Dumagat _amian_ ‘northeast wind’, Tagalog _amíhan_ ‘northeast wind’, Bikol _amíhan_ ‘northeast trade wind’, Maranao _amian_ ‘northwest wind’.
