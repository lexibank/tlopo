...
Talking about space is a part of talking about the environment as a whole. We include talking about space in this volume because some of the terms reconstructed in [§2](ContributionTable?anchor=s-2#cldf:2-8) are also used to denote parts of the landscape and seascape reconstructed in Chapters 3 and 4. However, much of the terminology reconstructed in this chapter was also used to talk about space in relation to manufactured objects (vol. 1), to flora and fauna (vols. 3 and 4) and to human beings (vol. 5). Many languages have complex terminologies for talking about space, and the length of this chapter bears witness to the fact that Proto Oceanic was no exception.

Following [Levinson](Source#cldf:Levinson1996) ([1996](Source#cldf:Levinson1996)) and [Hyslop](Source#cldf:Hyslop2001) ([2001](Source#cldf:Hyslop2001)), we distinguish four kinds of semantic system employed in talking about space. These are listed here with some commentary on their expression in Oceanic languages.
...
<a id="p-230"></a>
 ...
 1. A system of __geographic__ directions based on a division of the environment that
    ...
    near land, the other used at sea (cf. [Hill 1997](Source#cldf:Hill1997), [François 2003](Source#cldf:Francois2003), [2004a](Source#cldf:Francois2004a)). Typically each
    has two subsystems.
    (a) The land-based subsystems are (cf. [Ozanne-Rivierre 1997](Source#cldf:OzanneRivierre1997)):
    ...
    (b) The sea-based subsystems both refer to a northwest–southeast axis,
        (i)  one using the terms for the northwest storm wind and the southeast trade
             wind (POc &ast;apaRat and &ast;raki respectively; [Ch. 5, §4.2](ContributionTable?anchor=s-4-2#cldf:2-5));
        (ii) the other applying the river valley subsystem with its up/down axis (and
             ...
             towards the northwest and ‘up’ towards the southeast ([François 2003](Source#cldf:Francois2003), [2004a](Source#cldf:Francois2004a)).
 ...
 3. __Relative__ locations entail both the position of a reference person, often the speaker, and
    ...
    the latter do not entail a reference person ([Leech 1969](Source#cldf:Leech1969):167–168). For example, ‘in
    ...
    speaker’s body, not a direction ([Ozanne-Rivierre 1997](Source#cldf:OzanneRivierre1997)). Instead, one uses the
    geographic system: ‘seawards of the tree’, ‘go left-along-the-coast’ (cf. [Hill 1997](Source#cldf:Hill1997)).
...
(a) Some __local nouns__ ([§2](ContributionTable?anchor=s-2#cldf:2-8)) are used to express the directions of the vertical,
...
(b) __Directional__ morphemes ([§3](ContributionTable?anchor=s-3#cldf:2-8)) in verb phrases and in adjuncts are used in Oceanic
    ...
    Oceanic ([Ross 2003](Source#cldf:Ross2003)).[^2]:
(c) __Demonstratives__ are used as static _deictics_. The reconstruction of demonstratives
    is not treated in this chapter.

We can illustrate the typical Oceanic system by summarising the system in Longgu (SES) as described by [Hill](Source#cldf:Hill1992) ([1992](Source#cldf:Hill1992), [1997](Source#cldf:Hill1997), [2002](Source#cldf:Hill2002)). Local nouns marking the axes of the geographic system are _asi_ ‘seawards’, _loŋa_ ‘inland’, _alaʔa_ ‘east’, _toli_ ‘west’, _vuʔa_ ‘down’, _laŋi_ ‘up’. Longgu has terms meaning ‘left’ and ‘right’, but their referents are the arms and the sides of the body, and they do not form part of the system of spatial orientation and are not local nouns. Where English would use ‘left’ or ‘right’, a Longgu speaker refers to _aʔae asi_ ‘the seawards leg’ or _aʔae longa-i_ ‘the inland leg’. ‘Nouns such as _komu_ ‘village’ and _luma_ ‘house’ function as place [local] nouns when their referent is the village or house considered to be the “home” location’ ([Hill 1997](Source#cldf:Hill1997):103) and occur in different constructions from when they are used as common nouns (p.233). One of these constructions is with the preposition _i_ or with no preposition. Relational local nouns express intrinsic locations in relation to objects. For example, _ubu-_ ‘inside’ is treated as possessum in relation to the possessor _pera_ ‘basket’:

[2-8-1-None-231-3](examplegroups.csv#cldf:2-8-1-None-231-3)

Other relational local nouns are _buri-_ ‘behind’, _naʔova-_ ‘front’, _gege-_ ‘side’, _orova-_ ‘underneath’, _vavo-_ ‘top surface, space above’, _levua-_ ‘middle, centre’. Demonstratives are also a type of local noun, occurring with the preposition _i_ to indicate a location. Unlike many Oceanic languages, which have a person-oriented deictic system ([§3.4](ContributionTable?anchor=s-3-4#cldf:2-8)), Longgu deictics distinguish four degrees of deictic distance from the speaker: _nene_ ‘this, here’, _nina_ ‘that, there’, _ninaina_ ‘that yonder, yonder’ and _nihou_ ‘that/there far away’.

Like many Oceanic languages, Longgu has postverbal particles that distinguish motion towards and away from the speaker — _mai_ ‘hither’ and _hou_ ‘thither’ — and are hence deictic. Some languages have a third particle indicating motion towards the addressee ([§3.4](ContributionTable?anchor=s-3-4#cldf:2-8)), and others also have particles expressing the geographic directions ‘up (valley)’, ‘down (valley)’ and ‘across (valley)’ (§.3.3).
...
[2-8-2-None-232-4](examplegroups.csv#cldf:2-8-2-None-232-4)
...
[2-8-2-None-232-5](examplegroups.csv#cldf:2-8-2-None-232-5)
...
Inspection of the grammars of Oceanic languages shows that many have retained the distinction between local and common constructions, although a majority express it with morphemes other than reflexes of _&ast;i_ and _&ast;ta-_ (for elaboration, see [Ross 2004](Source#cldf:Ross2004)); see also the local prepositions listed under POc _&ast;la[-]_ (p.289). This inspection also shows that common nouns can be readily co-opted into the local construction. Thus it is common to find the common nouns for ‘house’, ‘garden’, ‘village’, ‘bush’ and ‘beach’ also occurring in the local construction, but this does not mean that the POc etyma they reflect necessarily occurred in the POc local construction.

As the Taiof examples above show, the division into common and local nouns cut across the division into zero-valency and monovalent nouns ([vol.1,32](ContributionTable?anchor=p-32#cldf:1-2)).

Zero-valency local nouns denoted familiar places like ‘home’, ‘own village’, ‘own garden’, ‘bush’, ‘beach’, i.e. locations whose reference would be clear to the addressee without further specification or whose exact reference was irrelevant (like the English construction with at and no article in at home, at school, at hospital, at work). Also belonging to the zero-valency local category were nouns denoting regions, either in relation to, say, the island home of the interlocutors or in relation to the speaker. These nouns denote geographic directions such as ‘up above’, ‘down below’, ‘inland’, ‘at sea’ and so on. There is no sharp distinction between these and nouns for familiar places: ‘inland’ and ‘bush’, for example, are often synonymous in Oceanic languages. This is not surprising. [Palmer](Source#cldf:Palmer2001) ([2001](Source#cldf:Palmer2001)) points out that the terms for a culture’s geographic directions are commonly grammaticised from perceptually salient phenomena of the landscape. These nouns have sometimes been labelled ‘absolute’ local nouns in the literature, to distinguish them from relational local nouns, but I prefer the label ‘geographic’ as some of their uses are deictic, referring to a location in relation to the speaker and addressee. Familiar-place and geographic local nouns are reconstructed in [§2.2](ContributionTable?anchor=s-2-2#cldf:2-8).

Monovalent local nouns, often labelled ‘relational’ nouns in the literature, referred to parts of objects. These are reconstructed in [§2.3](ContributionTable?anchor=s-2-3#cldf:2-8).

In POc the zero-valency/monovalent distinction was apparently not as sharp as it is in many modern Oceanic languages (Lynch, Ross & Crowley 2002:78–79), but there were semantically driven tendencies in the behaviour of nouns. When a noun was viewed as semantically inalienable, like the inside of an object, it was monovalent (i.e. directly possessed, with a possessor suffix), but the same noun could also have zero valency if used in a context where inalienability was irrelevant. For this reason, the relational nouns reconstructed in [§2.3](ContributionTable?anchor=s-2-3#cldf:2-8) have both monovalent and zero-valency forms, and we find cases where some reflexes of a relational noun are monovalent, others zero-valency.
...
[PAn &ast;_i_](cognatesetreferences.csv#cldf:2-8-2-1-236-POc-i-a)

Tongan, Niuafo’ou and East Uvean _ʔi_ are phonologically problematic, as they reflect POc _&ast;qi_, the form of the genitive preposition governing a non-specific inalienable possessor ([Pawley 1972](Source#cldf:Pawley1972), [Clark 1976](Source#cldf:Clark1976), [Hooper 1985](Source#cldf:Hooper1985), [Ross 1998b](Source#cldf:Ross1998b), [2001b](Source#cldf:Ross2001b)). However, as [Clark](Source#cldf:Clark1976) ([1976](Source#cldf:Clark1976)) and Blust (ACD) note, the introduction of a historically secondary glottal stop also occurs in some other Tongan grammatical formatives.
...
As mentioned above, a number of local nouns also formed POc local adverbs with the prefix _&ast;qa-_. [Jauncey](Source#cldf:Jauncey1997) ([1997](Source#cldf:Jauncey1997)) notes for Tamambo that the prefix _a-_ means ‘location in/at a place’, and must be prefixed to a noun signifying a place in relation to the speaker, i.e. a local noun. The cognate set is listed below. This is the _&ast;qa-_ which [Pawley](Source#cldf:Pawley1972) ([1972](Source#cldf:Pawley1972):82, 114) found in Southeast Solomonic and Northern Vanuatu languages as a formative of temporal adverbs (Ch. 9, p.324).

[POc &ast;_qa-_](cognatesetreferences.csv#cldf:2-8-2-1-237-POc-qa-a)
...
Some POc zero-valency local nouns, at least, were also used as common nouns, and this difference sometimes also entailed a difference in meaning. Thus _&ast;i tanoq_ meant ‘down there’ but _&ast;tanoq_ meant ‘earth, soil’ ([vol.1,119](ContributionTable?anchor=p-119#cldf:1-5)); _&ast;i qutan_ meant, among other things, ‘inland’, but _&ast;qutan_ meant ‘bushland’ ([vol.1,118](ContributionTable?anchor=p-118#cldf:1-5)).
...
As a common noun POc _&ast;qutan_ meant ‘bushland, hinterland’ ([vol.1,118](ContributionTable?anchor=p-118#cldf:1-5); this volume, [Ch. 3, §5.1](ContributionTable?anchor=s-5-1#cldf:2-3)). As a local noun, however, _&ast;qutan_ denoted the direction of the bush, namely ‘inland’. By extension, this has come to mean ‘upwards’ in a number of languages, by virtue of the fact that the inland region is significantly higher than the coast on many Pacific islands.

[PAn &ast;_quCaN_](cognatesetreferences.csv#cldf:2-8-2-2-238-POc-qutan-a)
...
[POc &ast;_loŋa_](cognatesetreferences.csv#cldf:2-8-2-2-239-POc-loa-a)
...
[PMP &ast;_lahud_](cognatesetreferences.csv#cldf:2-8-2-2-239-POc-laur-a)


<a id="p-240"></a>

[PMP &ast;_tasik_](cognatesetreferences.csv#cldf:2-8-2-2-240-POc-tasik-a)
...
[PWOc &ast;_pa_](cognatesetreferences.csv#cldf:2-8-2-2-240-PWOc-pa-a)

[PWOc &ast;_ta_](cognatesetreferences.csv#cldf:2-8-2-2-240-PWOc-ta-a)
...
The cognate set attesting POc _&ast;Rumaq_ ‘house’ was presented in [vol.1,48](ContributionTable?anchor=p-48#cldf:1-3). It is reasonably clear that it also functioned as a local noun in the phrase _&ast;i Rumaq_ ‘at home’, and apparently also in the adverb _&ast;qa-Rumaq_.

[PAn &ast;_Rumaq_](cognatesetreferences.csv#cldf:2-8-2-2-241-POc-rumaq-a)
...
POc _&ast;tanoq_ is reconstructed as a common noun meaning ‘earth, soil, ground; land’ in [vol.1,119](ContributionTable?anchor=p-119#cldf:1-5) and in this volume, p.41. However, there is well distributed evidence that as a local noun it meant ‘down below’. This is not surprising when one considers that POc speakers must generally have lived in stilt houses ([vol. 1, Ch. 3](ContributionTable#cldf:1-3)) for whose inhabitants the ground was indeed ‘down below’.

[PMP &ast;_taneq_](cognatesetreferences.csv#cldf:2-8-2-2-241-POc-tanoq-a)

The meanings above overlap with the adverb reflexes of POc _&ast;sipo_ ‘go downward’, (ADV) ‘down below’, but _&ast;tanoq_, a noun, and &ast;sipo a verb (and perhaps adverb), belonged to different word classes ([§3.3.1](ContributionTable?anchor=s-3-3-1#cldf:2-8)).
...
[PAn &ast;_aCas_](cognatesetreferences.csv#cldf:2-8-2-2-242-POc-atas-a)
...
[PAn &ast;_laŋiC_](cognatesetreferences.csv#cldf:2-8-2-2-243-POc-lait-a)
...
[POc &ast;_laka_](cognatesetreferences.csv#cldf:2-8-2-2-243-POc-laka-a)
...
[PMP &ast;_liwaŋ_](cognatesetreferences.csv#cldf:2-8-2-2-244-POc-liwa-a)
...
[2-8-2-3-244-6](examplegroups.csv#cldf:2-8-2-3-244-6)
...
[2-8-2-3-245-7](examplegroups.csv#cldf:2-8-2-3-245-7)

Hence we can with reasonable confidence make POc reconstructions such as:

[2-8-2-3-245-8](examplegroups.csv#cldf:2-8-2-3-245-8)

Many Oceanic languages have relational nouns with the meanings reconstructed below: ‘inside’ ([§2.3.1](ContributionTable?anchor=s-2-3-1#cldf:2-8)), ‘underneath, lower surface, space below’ ([§2.3.2](ContributionTable?anchor=s-2-3-2#cldf:2-8)), ‘top, upper surface, space above’ ([§2.3.3](ContributionTable?anchor=s-2-3-3#cldf:2-8)), ‘side’ ([§2.3.4](ContributionTable?anchor=s-2-3-4#cldf:2-8)), ‘outside’ ([§2.3.5](ContributionTable?anchor=s-2-3-5#cldf:2-8)), ‘front, time before’ ([§2.3.6](ContributionTable?anchor=s-2-3-6#cldf:2-8)), ‘back, space behind, time after’ ([§2.3.7](ContributionTable?anchor=s-2-3-7#cldf:2-8)). Although the nearest semantic equivalents of Oceanic relational nouns are English prepositions, I have used nouns and noun phrases in the titles of these subsections in an attempt to replicate the meanings of the reconstructed Oceanic terms.[^11]:

In their monovalent form, relational local nouns are reconstructed below like other monovalent nouns, i.e. without their final consonant, on the assumption that it was lost before a possessor suffix: for example, _&ast;lalom_ ‘inside’ became _&ast;lalo-_, &ast;papak ‘underneath’ became _&ast;papa-_. However, as I note in [Lynch et al.](Source#cldf:Lynchetal2002) ([2002](Source#cldf:Lynchetal2002), Ch. 4), there is some evidence from Tanna languages (SV) that POc retained the final consonant in this context, so that, e.g., POc _&ast;lalo-ña_ in the reconstructed example above may have been (optionally?) _&ast;lalom-ña_.
...
In Polynesian languages reflexes of _&ast;lalo-_/_&ast;lalom_ denote the region underneath something. [Blust](Source#cldf:Blust1997) ([1997](Source#cldf:Blust1997)) suggests that this meaning change comes from the use of _&ast;lalom_ in relation to a planar surface, the sea, rather than a three-dimensional container.

[PMP &ast;_Daləm_](cognatesetreferences.csv#cldf:2-8-2-3-246-POc-lalo-a)


<a id="p-247"></a>

There is evidence that POc _&ast;lalo-_ had two short forms, _&ast;lo-_ and _&ast;la-_. A number of their reflexes occur as prepositions and may have been conflated with reflexes of POc _&ast;lako_/_&ast;la_ ‘go (to); away from speaker’. They are listed together with a discussion of this conflation in [§3.4.5](ContributionTable?anchor=s-3-4-5#cldf:2-8). Listed below are those reflexes of the short forms which are not prepositions; most are local nouns. Significantly, there is a difference between the distributions of the two short forms. Reflexes of _&ast;lo-_ occur quite commonly as local nouns, and a number of them have a fossilised prefix reflecting the POc local preposition _&ast;i_. Reflexes of _&ast;la-_ have a stronger tendency to occur as prepositions (p.288), and may reflect the short form of _&ast;lako_ rather than of _&ast;lalo-_.

There is, of course, also a possibility that _&ast;lalo-_ has undergone haplology to form _&ast;lo-_ more than once in the history of Oceanic languages, but reflexes of _&ast;lo-_ below and in [§3.4.5](ContributionTable?anchor=s-3-4-5#cldf:2-8) are widespread enough to warrant its reconstruction in POc.

[POc &ast;_lo-_](cognatesetreferences.csv#cldf:2-8-2-3-247-POc-lo-a)

[POc &ast;_la-_](cognatesetreferences.csv#cldf:2-8-2-3-247-POc-la-a)
...
[POc &ast;_loto_](cognatesetreferences.csv#cldf:2-8-2-3-248-POc-loto-a)
...
[POc &ast;_bʷal(o,a)-_](cognatesetreferences.csv#cldf:2-8-2-3-248-POc-baloa-a)

[PMP &ast;_tinaqi_](cognatesetreferences.csv#cldf:2-8-2-3-248-POc-tinaqe-a)
...
[PMP &ast;_babaq_](cognatesetreferences.csv#cldf:2-8-2-3-249-POc-papa-a)
...
The second term, POc _&ast;gabʷari-_ meant ‘the area underneath a raised house’ ([vol.1,51](ContributionTable?anchor=p-51#cldf:1-3)) and has come to mean ‘underneath’ in some languages by extension. POc _&ast;puqu-_, _puqun_ had the relational meaning ‘base, foundation’ when used in association with an object, as well as the more abstract meaning ‘origin, source, reason’.

[POc &ast;_ruku-_](cognatesetreferences.csv#cldf:2-8-2-3-250-POc-ruku-a)

[POc &ast;_gabʷari-_](cognatesetreferences.csv#cldf:2-8-2-3-250-POc-gabari-a)


<a id="p-251"></a>

[PMP &ast;_puqun_](cognatesetreferences.csv#cldf:2-8-2-3-251-POc-puqu-a)
...
[PMP &ast;_babaw_](cognatesetreferences.csv#cldf:2-8-2-3-252-POc-papo-a)
...
[PAn &ast;_qulu_](cognatesetreferences.csv#cldf:2-8-2-3-253-POc-qulu-a)
...
[PMP &ast;_baliw_](cognatesetreferences.csv#cldf:2-8-2-3-255-POc-bali-a)
...
It is reasonably clear that the ‘inside’/‘outside’ opposition found in European languages did not occur in POc. This is unsurprising, since POc relation terms were nouns denoting parts of an object. The inside of a house is readily conceived as a part of it (POc _&ast;lalo-_), but the English term ‘outside’ only denotes a part insofar as it refers to the external surfaces of the building. As noted at various points in [§2.3](ContributionTable?anchor=s-2-3#cldf:2-8), terms which denote (among other things) particular external surfaces are also used metonymically to denote the external surface or ‘outside’ of an object in general. This is true of some reflexes of POc _&ast;papo[-]_ ‘upper surface, top’ (p.252), of POc _&ast;muri[-]_ ‘back part, rear’ (p.261) and of PEOc _&ast;tapa-_ ‘side, outside’ (above).


<a id="p-256"></a>

The terms in the set below could tempt us to reconstruct POc _&ast;luku-_ ‘side, outside’.[^16]: However, their uneven distribution is suspicious, and it seems far more likely that they reflect PMP _&ast;likuD_, POc _&ast;liku(r)_ ‘(person’s) back’ ([Blust 1981b](Source#cldf:Blust1981b)). The meaning of scattered reflexes of this word has extended to include the backs and rear parts of inanimate objects (like POc _&ast;muri[-]_), and thence the external surfaces of objects in general. The specification of ‘back’ in the Marshallese and Woleaian reflexes below supports this interpretation.

[2-8-2-3-256-yap-yapese-wuu](cf.csv#cldf:2-8-2-3-256-yap-yapese-wuu)
...
As the glosses indicate, POc _&ast;muqa[-]_ had the temporal sense of ‘time before’ as well as the local sense of ‘front’. It was thus the antonym of POc _&ast;muri[-]_ ‘back, time after’ ([§2.3.7](ContributionTable?anchor=s-2-3-7#cldf:2-8)).

[POc &ast;_muqa&#91;-&#93;_](cognatesetreferences.csv#cldf:2-8-2-3-257-POc-muqa-a)
...
[PWOc &ast;_muga_](cognatesetreferences.csv#cldf:2-8-2-3-258-PWOc-muga-a)
...
[PAn &ast;_maCa_](cognatesetreferences.csv#cldf:2-8-2-3-259-POc-mata-a)

[POc &ast;_nako&#91;-&#93;_](cognatesetreferences.csv#cldf:2-8-2-3-259-POc-nako-a)
...
[PMP &ast;_ma-udehi_](cognatesetreferences.csv#cldf:2-8-2-3-261-POc-muri-a)
...
[Proto Northwest Solomonic &ast;_mudi-_](cognatesetreferences.csv#cldf:2-8-2-3-262-ProtoNorthwestSolomonic-mudi-a)
...
[PMP &ast;_burit_](cognatesetreferences.csv#cldf:2-8-2-3-262-POc-burit-a)
...
[POc &ast;_takuRu&#91;-&#93;_](cognatesetreferences.csv#cldf:2-8-2-3-263-POc-takuru-a)
...
[PMP &ast;_pai_](cognatesetreferences.csv#cldf:2-8-2-4-264-POc-pai-a)
...
[POc &ast;_pea_](cognatesetreferences.csv#cldf:2-8-2-4-265-POc-pea-a)
...
Directional verbs play an important role in certain serial verb constructions in Oceanic languages, and they evidently did so in POc, to judge both from the wide distribution of such constructions today and from grammaticised versions of these constructions ([Ross 2003](Source#cldf:Ross2003)).
...
[2-8-3-1-267-9](examplegroups.csv#cldf:2-8-3-1-267-9)

[2-8-3-1-267-10](examplegroups.csv#cldf:2-8-3-1-267-10)
...
[2-8-3-1-267-11](examplegroups.csv#cldf:2-8-3-1-267-11)
...
[2-8-3-1-267-12](examplegroups.csv#cldf:2-8-3-1-267-12)
...
[2-8-3-1-267-13](examplegroups.csv#cldf:2-8-3-1-267-13)
...
Directional verbs are grammaticised in a number of ways in Oceanic languages ([Lichtenberk 1991](Source#cldf:Lichtenberk1991)). Three of these grammaticisation paths give rise to morphemes expressing location and direction. Reflexes of directional verbs which have undergone these grammaticisations occur in the cognate sets below, and for that reason are described here.

In the first type of grammaticisation, a directional verb in a serial verb construction loses its subject proclitic/prefix and becomes a directional adverbial enclitic (glossed DIR in cogate sets). In the two Sisiqa (MM) examples below, the directional enclitics _=me_ and _=la_ reflect the POc deictic directional verb forms _&ast;ma_ ‘come’ and _&ast;la_ ‘go:2’ ([§3.4](ContributionTable?anchor=s-3-4#cldf:2-8)) respectively. Each is preceded by a locomotion verb (‘carry’, ‘walk’), reflecting an earlier serial verb construction of deictic direction.

[2-8-3-2-267-14](examplegroups.csv#cldf:2-8-3-2-267-14)


<a id="p-268"></a>

In this Manam (NNG) example there is a sequence of locomotion verb (‘take’) and two directional enclitics, _-raʔe_ ‘up, to one’s right when facing sea’ (< geographical directional verb POc _&ast;sake_ ‘go up’, p.273) and _-laʔo_ ‘away’ (< deictic directional verb POc _&ast;lako_ ‘go:3’, p.287) reflecting an earlier three-verb sequence ([Lichtenberk 1983](Source#cldf:Lichtenberk1983):576–582).

[2-8-3-2-268-15](examplegroups.csv#cldf:2-8-3-2-268-15)

In the second type of grammaticisation, described by [Pawley](Source#cldf:Pawley1973) ([1973](Source#cldf:Pawley1973)) and [Durie](Source#cldf:Durie1988) ([1988](Source#cldf:Durie1988)), a directional verb in a serial verb construction is reanalysed as a preposition or a relator (see below) and comes to form a constituent primarily with the following locative expression. Prepositional reflexes of POc _&ast;mai_ ‘come’ occur in Polynesian languages. In Samoan, for example, we find ([Mosel & Hovdhaugen 1992](Source#cldf:MoselandHovdhaugen1992):147):

[2-8-3-2-268-16](examplegroups.csv#cldf:2-8-3-2-268-16)

In Meso-Melanesian languages of New Britain and New Ireland and in Longgu (SES), the deictic directional verbs _&ast;mai_ ‘come’ and _&ast;ua_ ‘go:2’ have become respectively ablative and allative relators ([Ross 2003](Source#cldf:Ross2003)). I use the term ‘relator’ for a preposition-like morpheme which differs in its distribution from a preposition in that it precedes either a prepositional phrase or a local noun. This distribution reflects its verbal ancestry: a POc deictic directional verb could be followed by a locative expression consisting of a local noun or a prepositional phrase. Hence in Longgu, vu is the allative relator reflecting &ast;ua:

[2-8-3-2-268-17](examplegroups.csv#cldf:2-8-3-2-268-17)

In the third, least widespread, grammaticisation type, the deictic directional verb in a sequential serial verb construction becomes a pre-verbal clitic indicating the location or direction of the event in relation to the speech act participants. In the best described case, Sinaugoro (PT) ([Tauberschmidt 1999](Source#cldf:Tauberschmidt1999):31–32), the clitics are enclitics to the preverbal subject/aspect/mood marking complex. In this example =ma reflects POc _&ast;ma_ ‘come’.

[2-8-3-2-268-18](examplegroups.csv#cldf:2-8-3-2-268-18)
...
Recent work by [François](Source#cldf:Francois2003) ([2003](Source#cldf:Francois2003), [2004a](Source#cldf:Francois2004a)) suggests strongly that this subsystem was also applied metaphorically to directions at sea. The two cardinal directions at sea were evidently provided by the major winds, POc _&ast;apaRat_, the northwest storm wind, and _&ast;raki_, the southeast trade wind, as the reflexes below (repeated from [Chapter 5, §4.2](ContributionTable?anchor=s-4-2#cldf:2-5)) suggest:

[PMP &ast;_habaRat_](cognatesetreferences.csv#cldf:2-8-3-3-269-POc-aparat-a)

[POc &ast;_raki_](cognatesetreferences.csv#cldf:2-8-3-3-269-POc-raki-a)
...
In [Ross](Source#cldf:Ross1995c) ([1995c](Source#cldf:Ross1995c)) I suggested that _&ast;sake_ ‘go up’ and _&ast;sipo_ ‘go down’ were used by POc speakers to denote ‘east’ and ‘west’, i.e. the locations of sunrise and sunset. This inference was based on the fact that the glosses for their reflexes in many Oceanic languages are given as ‘east’ and ‘west’ (this is also true of some of the sources that [François 2004a](Source#cldf:Francois2004a) cites). However, François argues in his detailed account of Mwotlap directional systems that this is semantically implausible, as reflexes of _&ast;sake_ and _&ast;sipo_ are used for ‘go southeast’ and ‘go northwest’ respectively, and it is hard to see how these meanings — or ‘go east’ and ‘go west’ — could be derived from ‘go to the place where the sun rises/sets’ ([François 2003](Source#cldf:Francois2003)). In [François](Source#cldf:Francois2004a) ([2004a](Source#cldf:Francois2004a)) he also presents the systems of a number of languages which display the ‘go up/southeast’ and ‘go down/northwest’ correlations. I find his reconstruction of a terminological subsystem corresponding to the major wind directions convincing, and I think it likely that systems which are oriented to the rising and setting of the sun are probably more recent developments.

[François](Source#cldf:Francois2004a) ([2004a](Source#cldf:Francois2004a)) is a reconstruction of a POc terminological subsystem, i.e. a system of meanings and the relationships among them. The languages in his sample by no means all use reflexes of _&ast;sipo_ and _&ast;sake_ for ‘go downward’ and ‘go upward’, and he makes no attempt to reconstruct the POc forms, assuming that the relevant POc etyma were _&ast;sipo_ and _&ast;sake_. I return briefly to the reconstruction of _&ast;sipo_ and _&ast;sake_ as directions at sea in [§3.3.3](ContributionTable?anchor=s-3-3-3#cldf:2-8) below.
...
[POc &ast;_sipo_](cognatesetreferences.csv#cldf:2-8-3-3-271-POc-sipo-a)


<a id="p-272"></a>

[PEMP &ast;_sobu_](cognatesetreferences.csv#cldf:2-8-3-3-272-POc-sobu-a)

[PMP &ast;_surup_](cognatesetreferences.csv#cldf:2-8-3-3-272-POc-surup-a)
...
[POc &ast;_&#91;s,j&#93;u&#91;(a,u)&#93;_](cognatesetreferences.csv#cldf:2-8-3-3-272-POc-sjuau-a)
...
[POc &ast;_wau_](cognatesetreferences.csv#cldf:2-8-3-3-273-POc-wau-a)

[POc &ast;_bala_](cognatesetreferences.csv#cldf:2-8-3-3-273-POc-bala-a)
...
[POc &ast;_sake_](cognatesetreferences.csv#cldf:2-8-3-3-273-POc-sake-a)
...
[2-8-3-3-275-nng-takia-sda](cf.csv#cldf:2-8-3-3-275-nng-takia-sda)
...
Above I noted [François’](Source#cldf:Francois2004a) ([2004a](Source#cldf:Francois2004a)) reconstruction of POc speakers’ use of terms for ‘go downward’ and ‘go upward’ for ‘go northwest’ and ‘go southeast’, i.e. directions corresponding with those of the major winds. François assumes that the relevant POc terms were _&ast;sipo_ and _&ast;sake_, reconstructed in §§[3.3.1](ContributionTable?anchor=s-3-3-1#cldf:2-8)-[3.3.2](ContributionTable?anchor=s-3-3-2#cldf:2-8). As these were the generic terms for ‘go downward’ and ‘go upward’, his assumption is probably correct, but it is not particularly well supported by the available data, as the sets below show. In fact, all supporting data for both terms in these meanings come from Eastern Oceanic languages. The Yabem and Motu reflexes of _&ast;sipo_ have ‘wrong’ directions in their glosses. This may mean that this use of &ast;sake and _&ast;sipo_ was an Eastern Oceanic innovation, but it may also mean that insufficient Western Oceanic (and Admiralties) systems have been carefully recorded. In a number of Western Oceanic languages, ‘east’ and ‘west’ are translated as ‘place where the sun rises’ and ‘place where the sun sets’, but these phrasal expressions may be modern renderings of English ‘east’ and ‘west’.

[POc &ast;_sipo_](cognatesetreferences.csv#cldf:2-8-3-3-275-POc-sipo-a)


<a id="p-276"></a>

[POc &ast;_sake_](cognatesetreferences.csv#cldf:2-8-3-3-276-POc-sake-a)

François also alludes to members of the Polynesian sets below. However, these are clearly locative nouns, and may just as well reflect an orientation to sunset and sunrise, as [Biggs](Source#cldf:Biggs1994) ([1994](Source#cldf:Biggs1994):25) implies.

[PPn &ast;_si-sifo_](cognatesetreferences.csv#cldf:2-8-3-3-276-PPn-sisifo-a)

[PPn &ast;_sa-sake_](cognatesetreferences.csv#cldf:2-8-3-3-276-PPn-sasake-a)

The important point about François’ reconstruction is that the equation of ‘go downward’ and ‘go upward’ with ‘go northwest’ and ‘go southeast’ occurs widely, suggesting that the equation itself should be reconstructed for POc, even if the forms themselves are hard to reconstruct. Except for Wayan, the terms listed below are drawn from [François](Source#cldf:Francois2004a) ([2004a](Source#cldf:Francois2004a)).
...
[POc &ast;_sipo_](cognatesetreferences.csv#cldf:2-8-3-3-277-POc-sipo-a)

[POc &ast;_sake_](cognatesetreferences.csv#cldf:2-8-3-3-277-POc-sake-a)
...
The person-oriented system of deixis was manifested not only in demonstratives, but also in the system of deictic directional verbs. POc had a system with at least three members: ‘come to[wards] speaker’, ‘go/come to[wards] addressee’ and ‘go to a point away from both speaker and addressee’, glossed here as ‘come’, ‘go:2’ and ‘go:3’ respectively. There were possibly two ‘go:3’ verbs, however. One licensed a location expression, i.e. its basic meaning was ‘go to’. The other simply meant ‘go away (from speaker)’ and did not license a location expression. Thus in Kele (Adm) there is a contrast between _la_ ‘go to’ and _aw_ ‘go away’ ([Ross 2002f](Source#cldf:Ross2002f)). This suggests that POc had a four-member system, and I will assume this here. Against this is the fact that I have found no language in which a four-member system is preserved.
...
[PAn &ast;_maRi_](cognatesetreferences.csv#cldf:2-8-3-4-281-POc-mai-a)
...
In a number of languages POc _&ast;mai_/_&ast;ma_ is reflected as a preposition or a relator. However, the reflexes listed below are probably the result of parallel innovations in different groups of languages, and it is unnecessary to reconstruct a preposition or relator usage for POc _&ast;mai_/_&ast;ma_ (cf. [§3.2](ContributionTable?anchor=s-3-2#cldf:2-8)).

[POc &ast;_mai_](cognatesetreferences.csv#cldf:2-8-3-4-283-POc-mai-a)
...
[POc &ast;_pʷati_](cognatesetreferences.csv#cldf:2-8-3-4-283-POc-pati-a)
...
[POc &ast;_ua_](cognatesetreferences.csv#cldf:2-8-3-4-284-POc-ua-a)

In a number of languages POc _&ast;ua_ is reflected as a preposition or a relator (cf. [§3.2](ContributionTable?anchor=s-3-2#cldf:2-8)).

[POc &ast;_ua_](cognatesetreferences.csv#cldf:2-8-3-4-284-POc-ua-b)

Proto South Vanuatu _&ast;un-_, which forms locative nouns from common nouns ([Lynch 2001c](Source#cldf:Lynch2001c):132), may also belong here.


<a id="p-285"></a>

Longgu _vu_ appears to be cognate with forms in the Malaita/Makira subgroup (SES) that reflect Proto Malaita/Makira _&ast;vua_ or _&ast;vuni_. [Lichtenberk](Source#cldf:Lichtenberk1985b) ([1985b](Source#cldf:Lichtenberk1985b)) attributes all these forms to POc _&ast;pani_ (V) ‘give’, (PREPV) ‘beneficiary case-marker’. The Malaita/Makira forms certainly have benefactive meanings, but Longgu _vu_ is clearly allative, and the best account of both its form and meaning is given by attributing it to _&ast;ua_ — although this means assuming that initial _&ast;v-_ has arisen by epenthesis. But what are we to do with the Malaita/Makira forms? The best explanation seems to be that there was a conflation of pre-Proto Malaita/Makira _&ast;vua_ ‘allative relator’ (cognate with Longgu _vu_ and reflecting POc _&ast;ua_) and _&ast;vani_ ‘beneficiary prepositional verb’ (reflecting POc _&ast;pani_), resulting in _&ast;vua_ with a benefactive function and _&ast;vuni_ with a form cobbled together from both items but in benefactive function.

This interpretation is supported by the Longgu dative verbal preposition _wini-_, which takes an object pronoun suffix when it governs a first or second person referent, e.g. _wini-o_ DATIVE-O:2SG ‘to you’, but assumes the allomorph _wa-_ with a possessor pronoun suffix when it governs a third person, e.g. _wa-na_ DATIVE-P:3SG ‘to it/him/her’.[^29]: As [Hill](Source#cldf:Hill1992) ([1992](Source#cldf:Hill1992):245) points out, _wa-_ overlaps semantically with _vu_ (< POc _&ast;ua_). It appears that _wini_ reflects POc _&ast;pani_ and _wa-_ POc _&ast;ua_, but the two form a single paradigm in Longgu. This inference would also explain the non-etymological initial _&ast;v-_ of _vu_: it is inherited from pre-Proto Malaita/Makira _&ast;vua_, where it resulted from ‘infection’ by _&ast;vani_.
...
[POc &ast;_ua_](cognatesetreferences.csv#cldf:2-8-3-4-285-POc-ua-a)
...
[POc &ast;_watu_](cognatesetreferences.csv#cldf:2-8-3-4-286-POc-watu-a)
...
[PMP &ast;_lako_](cognatesetreferences.csv#cldf:2-8-3-4-287-POc-lako-a)
...
[2-8-3-4-289-19](examplegroups.csv#cldf:2-8-3-4-289-19)
...
As noted in [§3.3](ContributionTable?anchor=s-3-3#cldf:2-8), some reflexes of POc _&ast;pano_ indicate that it was also a geographic directional verb meaning ‘move in a transverse direction’, contrasting with ‘go up, go inland’ and ‘go down, go seawards’. However, it is not entirely clear whether this usage occurred in POc. On one hand, there is a non-Oceanic reflex with this meaning, namely Aralle-Tabulahan (South Sulawesi) _pano_ (DIR) ‘along the level’ ([McKenzie 1997](Source#cldf:Mckenzie1997)). On the other hand, within Oceanic the meaning ‘move in a transverse direction’ is reflected only in North–Central Vanuatu and New Caledonian languages. There are two interpretations of these data: either there were independent parallel innovations in South Sulawesi and Remote Oceanic, or this usage was inherited into POc but happens to have been lost in Western Oceanic and Southeast Solomonic.

[PMP &ast;_panaw_](cognatesetreferences.csv#cldf:2-8-3-4-290-POc-pano-a)

The Harua form _mano_ appears to reflect the application of the PMP Actor focus morpheme _&ast;‹um›_ to the root _&ast;panaw_ ([vol.1,29](ContributionTable?anchor=p-29#cldf:1-2)), suggesting that an alternation between _&ast;pano_ and _&ast;mano_ may have survived in POc.
...
[POc &ast;_pa_](cognatesetreferences.csv#cldf:2-8-3-4-291-POc-pa-a)

The meanings of reflexes of _&ast;pa_ agree with those of _&ast;pano_, and the function of the Motu, Sinaugoro,[^32]: Gela, and Mota reflexes of _&ast;pa_ (in three different subgroups) as a preverbal auxiliary is similar to that of the Sinaugoro reflexes of _&ast;ma_ and _&ast;la_ above. [Clark](Source#cldf:Clark1996) ([1996](Source#cldf:Clark1996)) notes that Nguna _vā_ ‘go’ is also described as a short form of _vano_. [Paton](Source#cldf:Paton1973) ([1973](Source#cldf:Paton1973)) describes Lonwolwol _va_ as a short form of _van_ ‘go, pass’, and therefore as a reflex of POc _&ast;pano_, but Blust (ACD) argues that his inference is unjustified since original medial nasals are otherwise retained in Lonwolwol. If, however, _va_ reflects POc _&ast;pa_, the objection disappears.

This leaves a loose end. Blust (ACD) takes the cognate set above to reflect PCEMP _&ast;ba_ ‘go, go away, walk’. [Clark](Source#cldf:Clark1996) ([1996](Source#cldf:Clark1996)), on the other hand, infers that the set above and PCEMP _&ast;ba_ are etymologically separate. It is true that the forms attributed to POc _&ast;pa_ above could reflect PCEMP _&ast;ba_: there is no phonological objection to this. But there are just a few Oceanic forms which reflect a POc locomotion verb _&ast;ba_ ‘go’ (Tolai [MM] _ba_ ‘tread, go’, Talise [SES] _ba_ ‘go’), and it seems likely that this _&ast;ba_ reflects PCEMP _&ast;ba_, whilst POc _&ast;pa_ is the short form of _&ast;pano_.
...
[2-8-3-4-292-20](examplegroups.csv#cldf:2-8-3-4-292-20)

Relators reflect erstwhile deictic directional verbs ([Ross 2003](Source#cldf:Ross2003)), and so _&ast;pano_/_&ast;pa_ is the most likely candidate for the ancestor of Hoava _pa_. Other probable straightforward reflexes of _&ast;pano_/_&ast;pa_ are the Kiriwina, Roviana and Nguna forms, and perhaps the Label locative preposition _ha_, as it contrasts with instrumental _pa_ (from PWOc _&ast;pʷa_).

The NNG items below, all from the Vitiaz Strait area, probably reflect conflation of the POc benefactive prepositional verb _&ast;pani_ and a PWOc instrumental preposition _&ast;pʷa_ ([Ross 1988](Source#cldf:Ross1988):106–108, 112–115).
...
| 2.  | POc              | &ast;pani      | ‘give’, (PREPV) benefactive ([Pawley 1973](Source#cldf:Pawley1973), [Lichtenberk 1985b](Source#cldf:Lichtenberk1985b)) |
...
[POc &ast;_&#91;y&#93;aku_](cognatesetreferences.csv#cldf:2-8-3-4-293-POc-yaku-a)
...
POc _&ast;tani_ was a prepositional verb, reconstructed by [Pawley](Source#cldf:Pawley1973) ([1973](Source#cldf:Pawley1973)). It was not deictic, i.e. not oriented with regard to speaker or hearer, and so strictly does not belong here. It was transitive, and the object of the verb was the point of orientation from which movement takes place. I include it because its reflexes have become deictic directional adverbs in a few languages.

[POc &ast;_tani_](cognatesetreferences.csv#cldf:2-8-3-4-293-POc-tani-a)
...
In addition to the sources of lexical items listed in Appendix 1, a number of grammars and other grammatical sources were consulted during the research on which this chapter is based. Other than my fieldnotes, these are: NE Ambae ([Hyslop 2001](Source#cldf:Hyslop2001)), Anejom ([Lynch 2000b](Source#cldf:Lynch2000b)), Araki ([François 2002](Source#cldf:Francois2002)), Arosi ([Lynch & Horoi 2002](Source#cldf:LynchandHoroi2002)), Awad Bing ([Bennett & Bennett 1998](Source#cldf:BennettandBennett1998)), Bali-Vitu ([Ross 2002a](Source#cldf:Ross2002a)), Banoni ([Lynch & Ross 2002](Source#cldf:LynchandRoss2002)), Bariai ([Gallagher 1998](Source#cldf:Gallagher1998)), Bauan Fijian ([Churchward 1973](Source#cldf:Churchward1973), [Schütz 1985](Source#cldf:Schutz1985)), Boumaa Fijian ([Dixon 1988](Source#cldf:Dixon1988)), Bugotu ([Ivens 1933](Source#cldf:Ivens1933), author’s fieldnotes), Cèmuhî ([Lynch 2002a](Source#cldf:Lynch2002a)), Drehu ([Moyse-Faurie 1993](Source#cldf:MoyseFaurie1993)), Erromangan (Sye) ([Crowley 1998](Source#cldf:Crowley1998)), Gapapaiwa ([McGuckin 2002](Source#cldf:Mcguckin2002)), Gela ([Crowley 2002a](Source#cldf:Crowley2002a)), Gumawana ([Olson 1992](Source#cldf:Olson1992)), Halia ([Allen 1987](Source#cldf:Allen1987)), Hoava ([Davis 1997](Source#cldf:Davis1997)), Iaai ([Ozanne-Rivierre 2004](Source#cldf:OzanneRivierre2004)), Ifira-Mele ([Clark 2002](Source#cldf:Clark2002)), Kairiru ([Wivell 1981b](Source#cldf:Wivell1981b), [Ross 2002e](Source#cldf:Ross2002e)), Kele ([Ross 2002f](Source#cldf:Ross2002f)), Kiriwina ([Senft 1986](Source#cldf:Senft1986)), Kiribati ([Groves, Groves & Jacobs 1985](Source#cldf:Grovesetal1985)), Kokota ([Palmer 1999](Source#cldf:Palmer1999)), Kosraean ([Lee 1975](Source#cldf:Lee1975)), Kwaio ([Keesing 1985](Source#cldf:Keesing1985)), Kwamera ([Lindstrom 1986](Source#cldf:Lindstrom1986)), Label ([Peekel 1930](Source#cldf:Peekel1930)), Lenakel ([Lynch 1978c](Source#cldf:Lynch1978c)), Lewo ([Early 1994a](Source#cldf:Early1994a)), Longgu ([Hill 1992](Source#cldf:Hill1992), [1997](Source#cldf:Hill1997)), Loniu ([Hamel 1994](Source#cldf:Hamel1994)), Lukep (Pono) ([D’Jernes & D’Jernes n.d.](Source#cldf:DjernesandDjernesnd)), Lusi ([Counts 1969](Source#cldf:Counts1969)), Manam ([Lichtenberk 1983](Source#cldf:Lichtenberk1983)), Mangap-Mbula ([Bugenhagen 1995](Source#cldf:Bugenhagen1995)), Marquesan ([Lynch 2002b](Source#cldf:Lynch2002b)), Mekeo ([Jones 1998](Source#cldf:Jones1998)), Merei ([Chung 1998](Source#cldf:Chung1998)), Minaveha ([Lovell 1994](Source#cldf:Lovell1994)), Mokilese ([Harrison 1976](Source#cldf:Harrison1976)), Motu ([Lister-Turner & Clark 1954b](Source#cldf:ListerTurnerandClark1954b)), Mussau ([Ross 2002b](Source#cldf:Ross2002b)), Mwotlap ([Crowley 2002b](Source#cldf:Crowley2002b)), Nadrogaa Fijian ([Geraghty 2002](Source#cldf:Geraghty2002)), Nakanai ([Johnston 1980](Source#cldf:Johnston1980)), Nalik ([Volker 1998](Source#cldf:Volker1998)), Nêlêmwa ([Bril 1994](Source#cldf:Bril1994)), Nguna ([Schütz 1969](Source#cldf:Schutz1969)), Niuafo’ou ([Early 2002](Source#cldf:Early2002)), Notsi ([Erickson & Erickson 1992](Source#cldf:Ericksonanderickson1992)), Nyelâyu ([Ozanne-Rivierre 1998](Source#cldf:OzanneRivierre1998)), Paamese ([Crowley 1982](Source#cldf:Crowley1982)), Pileni (Næss, forthcoming), Puluwatese ([Lynch 2002c](Source#cldf:Lynch2002c)), Ramoaaina ([Davies & Fritzell 1992](Source#cldf:DaviesandFritzell1992)), Roviana ([Corston-Oliver 2002](Source#cldf:Corstonoliver2002)), Saliba (Margetts, forthcoming), Samoan (Mosel & Hovdaugen 1992), Siar ([Ross 2002c](Source#cldf:Ross2002c)), Sinaugoro ([Tauberschmidt 1999](Source#cldf:Tauberschmidt1999)), Sio ([Clark & Clark 1987](Source#cldf:ClarkandClark1987)), Sobei ([Sterner & Ross 2002](Source#cldf:SternerandRoss2002)), Sudest ([Anderson & Ross 2002](Source#cldf:AndersonandRoss2002)), Tamambo ([Jauncey 1997](Source#cldf:Jauncey1997)), Tawala ([Ezard 1997](Source#cldf:Ezard1997)), Tigak ([Beaumont 1979](Source#cldf:Beaumont1979)), Tinrin ([Osumi 1995](Source#cldf:Osumi1995)), Tobati ([Donohue 2002](Source#cldf:Donohue2002)), Tolai ([Mosel 1982](Source#cldf:Mosel1982), [1984](Source#cldf:Mosel1984), [Rinderknecht 1987](Source#cldf:Rinderknecht1987)), Tongan ([Churchward 1953](Source#cldf:Churchward1953)), Ulithian ([Lynch 2002d](Source#cldf:Lynch2002d)), Wailevu Fijian (Ritsuko Kikusawa pers. comm.), Wayan (Pawley & Sayaba, 2003), Woleaian ([Sohn 1975](Source#cldf:Sohn1975)), Xârâcùù ([Moyse-Faurie 1995](Source#cldf:MoyseFaurie1995)), Yabem ([Dempwolff 1939](Source#cldf:Dempwolff1939), [Zahn 1940](Source#cldf:Zahn1940), [Ross 2002d](Source#cldf:Ross2002d)), Zabana ([Fitzsimons 1989](Source#cldf:Fitzsimons1989)).
...
[^15]: The PMP etymon is discussed at length by [Blust](Source#cldf:Blust1980a) ([1980a](Source#cldf:Blust1980a)) and in the [ACD](Source#cldf:Blust1995).

[^16]: This putative item resembles POc _&ast;ruku-_ ‘underneath’, but this is probably fortuitous.

[^17]: There are non-Oceanic items that look cognate, but they are descended from borrowings of Sanskrit _mukha_ ‘face’. The items are Isneg _múkāt_ ‘face’, Ilokano _mukat_ ‘eye mucus’, Tagalog _mukhaʔ_, Indonesian _muka_ ‘face’, Balinese _muə_ ‘face’. Sasak _mua_ ‘face’ ([Gonda 1973](Source#cldf:Gonda1973):104). I am grateful to Robert Blust for this information.
...
[^23]: For a more detailed examination of this issue, see [Pawley](Source#cldf:Pawley2003b) ([2003b](Source#cldf:Pawley2003b)).
...
[^28]: Supporting data given by [Tsuchida](Source#cldf:Tsuchida1976) ([1976](Source#cldf:Tsuchida1976):235) are Kanakanavu _m-u-á-kusa_ ‘go’, Tsou _uso_ ‘go forward’, Saaroa _m-aɬu-kua_ ‘go where?’, Puyuma _mu-kuwaʔ_ ‘go’, Thao _m-úʃaʔ_ ‘go’, Pazeh _mu-husaʔ_ ‘go’, Atayal, Seediq _(m)usaʔ_ ‘go’, Rukai _(m)wa_ ‘go’.
