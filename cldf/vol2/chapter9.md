...
[Pawley](Source#cldf:Pawleynd) ([n.d.](Source#cldf:Pawleynd)) notes an idiomatic construction in which at least some of these terms co-occurred with POc _&ast;panua_ which, among other things, meant ‘the visible world, land and sky’ ([vol.1,62](ContributionTable?anchor=p-62#cldf:1-3)). The combination of _&ast;panua_ and _&ast;boŋi_, probably as a verb, is reflected in:
...
[PMP &ast;_beRŋi_](cognatesetreferences.csv#cldf:2-9-2-2-305-POc-boi-a)
...
[PMP &ast;_dem-dem_](cognatesetreferences.csv#cldf:2-9-2-2-308-POc-rodrom-a)

The two sets below probably do not reflect POc _&ast;rodrom_. Rather, _&ast;rodrom_ and the sets below all reflect a PAn monosyllabic root _&ast;-dem_ (see [vol.1,24](ContributionTable?anchor=p-24#cldf:1-2)–25, 27–28). That is, several items reflecting this root were separately inherited into POc.

[PMP &ast;_ma-edem_](cognatesetreferences.csv#cldf:2-9-2-2-308-POc-marom-a)
...
[PAn &ast;_daqaNi_](cognatesetreferences.csv#cldf:2-9-2-2-309-POc-raqani-a)
...
[PAn &ast;_qajaw_](cognatesetreferences.csv#cldf:2-9-2-2-309-POc-qaco-a)


<a id="p-310"></a>

[PMP &ast;_sinaR_](cognatesetreferences.csv#cldf:2-9-2-2-310-POc-sinar-a)
...
[POc &ast;_boŋi-boŋi_](cognatesetreferences.csv#cldf:2-9-2-2-310-POc-boiboi-a)
...
[POc &ast;_puko_](cognatesetreferences.csv#cldf:2-9-2-2-311-POc-puko-a)
...
[Biggs and Clark](Source#cldf:BiggsandClark1993) ([1993](Source#cldf:BiggsandClark1993)) reconstruct PPn _&ast;qaho-atea_ ‘late morning and early afternoon’, from PPn _&ast;qaho_ ‘daylight’ and _&ast;qātea_ ‘clear, unobstructed’. The addition of Anejom reflexes raises the reconstruction to PROc _&ast;qaso-qatea_ (Lynch pers. comm.).

[PROc &ast;_qaso-qatea_](cognatesetreferences.csv#cldf:2-9-2-2-312-PROc-qasoqatea-a)
...
[PAn &ast;_Rabi_](cognatesetreferences.csv#cldf:2-9-2-2-313-POc-rapi-a)
...
[PMic &ast;_fakāfi_](cognatesetreferences.csv#cldf:2-9-2-2-313-PMic-fakafi-a)
...
[PAn &ast;_bulaN_](cognatesetreferences.csv#cldf:2-9-2-3-315-POc-pulan-a)
...
[PPn &ast;_mā-sina_](cognatesetreferences.csv#cldf:2-9-2-3-315-PPn-masina-a)
...
Maximal systems, like those found in Micronesia and in Central Eastern Polynesian languages, have thirty names, one for each day of a lunar month.[^14]: Between the minimal and the maximal systems are systems that divide the month into phases of two or three nights each (e.g. Sa’a as reported by [Ivens 1927](Source#cldf:Ivens1927), [1929](Source#cldf:Ivens1929)). Some Oceanic communities, like Mwotlap (NCV), seem to divide the lunar month into phases based on sixths rather than quarters. That is, they have terms for the new moon and (roughly) the 5th, 10th, 15th, 20th and 25th days ([François 2001](Source#cldf:Francois2001)). From White, Kokhonigita and Pulomana’s (1988) dictionary definitions it seems that Maringe may also be such a language. Kiriwina apparently names days only from the 10th to the 20th day. The Lamotrek days, as listed by [Christian](Source#cldf:Christian1899) ([1899](Source#cldf:Christian1899)) are divided into two sections of respectively ten and twenty days.
...
The first phase is strictly speaking the days of darkness. Interestingly, the sources vary as to how many of these there are, and [Grimble](Source#cldf:Grimble1931) ([1931](Source#cldf:Grimble1931)) claims that the Kiribati did not know.

The denotation of the first visible phase often makes reference to the moon’s thin crescent shape. A number of languages compare it to a crescent-shaped pearlshell ornament, and it is possible that this image was also used in POc. Such artefacts have not appeared in the archaeological record, but they are fairly common ethnographically and a term for them, POc _&ast;japi_ was reconstructed in [vol.1(104](ContributionTable?anchor=p-104#cldf:1-4)). It is reflected in the Arosi term below.

[2-9-2-3-316-pt-motu-huadoai](cf.csv#cldf:2-9-2-3-316-pt-motu-huadoai)
...
[2-9-2-3-317-pt-kiriwina-kapatu](cf.csv#cldf:2-9-2-3-317-pt-kiriwina-kapatu)
...
[POc &ast;_pulan paqoRu_](cognatesetreferences.csv#cldf:2-9-2-3-317-POc-pulanpaqoru-a)
...
[2-9-2-3-317-pt-kiriwina-tubukonatubugeguda](cf.csv#cldf:2-9-2-3-317-pt-kiriwina-tubukonatubugeguda)
...
[2-9-2-3-317-adm-drehet-purekxek](cf.csv#cldf:2-9-2-3-317-adm-drehet-purekxek)

Maringe has a term with an apparently similar meaning to Mwotlap:

[2-9-2-3-317-mm-maringe-kafa](cf.csv#cldf:2-9-2-3-317-mm-maringe-kafa)
...
[2-9-2-4-319-nng-kove-hai](cf.csv#cldf:2-9-2-4-319-nng-kove-hai)

In [Ross](Source#cldf:Ross1995c) ([1995c](Source#cldf:Ross1995c)) I wrote, ‘There is … no doubt that POc had a separate (and widely reflected) word for year’, and followed it with the reconstruction of POc _&ast;taqun_ below. This statement stands, but with a qualification. The Buang, Tongan and East Futunan reflexes indicate that _&ast;taqun_ may have been used particularly to denote the yam-growing cycle. This would not be surprising: the greater yam, _Dioscorea alata_ (POc _&ast;qupi_; [Ross 1996d](Source#cldf:Ross1996d)) is a highly prized — but not especially nutritious — crop throughout much of Oceania, with much ritual associated with its growth cycle, and so it is a highly salient marker of a year. It is likely that that it already had the meaning ‘yam season cycle’ in POc times.

[PMP &ast;_taqun_](cognatesetreferences.csv#cldf:2-9-2-4-319-POc-taqun-a)


<a id="p-320"></a>

[Newell and Poligon](Source#cldf:NewellandPoligon1993) ([1993](Source#cldf:NewellandPoligon1993):486) define Batad Ifugao (Central Cordilleran, Philippines) _tawon_ as follows: ‘a measure of the time between a major event such as planting or harvesting rice until it recurs. Traditionally, reference is not to a calendar year; a year does not have a fixed beginning and end.’ The rice harvest was evidently replaced by the yam harvest in POc. Glosses in other languages suggest that _&ast;taqun_ was perhaps originally the name of a particular season, the dry season when food did not grow. We find Isneg (North Cordilleran) _mag-d‹in›axun_ ‘the hot, dry season’, derived from _taxun_ ‘year’ ([Vanoverbergh 1972](Source#cldf:Vanoverbergh1972)), and Binukid (Manobo) _taun_ ‘hunger season’ ([Post 1992](Source#cldf:Post1992)).

In Polynesian languages, there is a tendency, stronger in the east that in the west, for the reflex of POc _&ast;taqun_ / PPn _&ast;taqu_ to denote a ‘season’, in the sense of the dry season or the wet season. [Kirch and Green](Source#cldf:KirchandGreen2001) ([2001](Source#cldf:KirchandGreen2001):261, 265) believe that the use of these reflexes to mean ‘year’ postdates western contact, but it does seem that the annual cycle of planting and harvesting was a major element of the meaning of both POc _&ast;taqun_ and PPn _&ast;taqu_ ([Kirch & Green 2001](Source#cldf:KirchandGreen2001):267). The presence of the nominaliser _‹in›_ in the Patpatar and Ramoaaina reflexes above suggests that POc _&ast;taqun_ was also a verb meaning ‘last a year’.
...
The claim is sometimes made that Oceanic systems of spatial deixis are also used for temporal purposes. There are very few well documented cases of this beyond the use of the proximal demonstrative ‘here’ for ‘now’. Such cases are Nêlêmwa ([Bril 2002](Source#cldf:Bril2002)), Iaai ([Ozanne-Rivierre 2004](Source#cldf:OzanneRivierre2004)), Kosraean ([Lee 1975](Source#cldf:Lee1975):129), Mokilese ([Harrison 1976](Source#cldf:Harrison1976):77–81, 85) and Samoan ([Mosel 2004](Source#cldf:Mosel2004)). However, as [Anderson and Keenan](Source#cldf:AndersonandKeenan1985) ([1985](Source#cldf:AndersonandKeenan1985):298–299) observe with regard to Kosraean and Mokilese, even in these two Micronesian languages the temporal applications of the spatial deictics are not parallel. The same observation is true of the other languages just listed, and so no precise reconstruction of a temporal usage of spatial deictics in POc is possible.
...
[POc &ast;_muqa-_](cognatesetreferences.csv#cldf:2-9-3-2-322-POc-muqa-a)

[PMP &ast;_ma-udehi_](cognatesetreferences.csv#cldf:2-9-3-2-322-POc-muri-a)


<a id="p-323"></a>

[PMP &ast;_burit_](cognatesetreferences.csv#cldf:2-9-3-2-323-POc-burit-a)
...
[POc &ast;_tuqaRi_](cognatesetreferences.csv#cldf:2-9-3-2-323-POc-tuqari-a)
...
[PMP &ast;_ñeRab_](cognatesetreferences.csv#cldf:2-9-3-3-325-POc-norap-a)


<a id="p-326"></a>

The Southern Vanuatu members of the set below reflect a Proto South Vanuatu form reconstructed by [Lynch](Source#cldf:Lynch2001c) ([2001c](Source#cldf:Lynch2001c):211) as _&ast;na-yan(a,u)v_. POc _&ast;R_ is sporadically lost in Proto South Vanuatu, and these forms seem to reflect a metathesis of a reflex of _na-ñoRap_ to _&ast;na-Rañop_.

[POc &ast;_na-ñoRap_](cognatesetreferences.csv#cldf:2-9-3-3-326-POc-nanorap-a)
...
[2-9-3-3-327-pt-tawala-lolowa](cf.csv#cldf:2-9-3-3-327-pt-tawala-lolowa)
...
The forms below reflect Proto NCV _&ast;na-novi_ ‘yesterday’. This contrasts with Proto NCV _&ast;novi_ ‘tomorrow’ (Nokuku _pʷa-novi_, Kiai _i-novi_, Tolomako _i novi_) and so may have nothing to do with _&ast;na-ñoRap_. [Clark](Source#cldf:Clark1996) ([1996](Source#cldf:Clark1996)) thinks it reflects a conflation of POc _&ast;na-ñoRap_ and _&ast;na-Rapi_ (below), however, and he may be right.

[2-9-3-3-327-ncv-raga-ninovi](cf.csv#cldf:2-9-3-3-327-ncv-raga-ninovi)
...
[POc &ast;_na-boŋi_](cognatesetreferences.csv#cldf:2-9-3-3-327-POc-naboi-a)


<a id="p-328"></a>

A few Western Oceanic terms for ‘yesterday’ reflect POc _&ast;raqani_ ‘daytime, daylight’ (p.309). Reflexes in Sio (NNG) and in the Central Papuan subgroup of Papuan Tip languages have a prefix which appears to reflect a preposition reflex of POc _&ast;ua_ (VF) ‘go towards addressee’, (DIR) ‘towards addressee’ ([Ch. 8, §3.4.4](ContributionTable?anchor=s-3-4-4#cldf:2-8)).

[2-9-3-3-328-nng-sio-walani](cf.csv#cldf:2-9-3-3-328-nng-sio-walani)
...
[POc &ast;_i Rapi_](cognatesetreferences.csv#cldf:2-9-3-3-328-POc-irapi-a)
...
[2-9-3-3-329-adm-drehet-nekepi](cf.csv#cldf:2-9-3-3-329-adm-drehet-nekepi)
...
[POc &ast;_i boŋi-boŋi_](cognatesetreferences.csv#cldf:2-9-3-3-329-POc-iboiboi-a)
...
POc _&ast;ma-pua_ ‘tomorrow’ is reconstructable from the rather skewed cognate set below. Data from Sulawesi languages and Balinese cited by [Mead](Source#cldf:Mead2001) ([2001](Source#cldf:Mead2001)) point to the reconstruction of PMP _&ast;i-pu(h)a-n_ ‘day after tomorrow, day before yesterday’, and the POc root _&ast;-pua_ here apparently reflects PMP _&ast;-pu(h)a-_. However, the apparent shift in meaning is unexplained.

[POc &ast;_ma-pua_](cognatesetreferences.csv#cldf:2-9-3-3-330-POc-mapua-a)
...
[POc &ast;_ma-raqani_](cognatesetreferences.csv#cldf:2-9-3-3-330-POc-maraqani-a)
...
[POc &ast;_la-tuqu_](cognatesetreferences.csv#cldf:2-9-3-3-331-POc-latuqu-a)
...
[POc &ast;_&#91;i&#93; waRisa_](cognatesetreferences.csv#cldf:2-9-3-3-332-POc-iwarisa-a)


<a id="p-333"></a>

[POc &ast;_&#91;qa-&#93;na-waRisa_](cognatesetreferences.csv#cldf:2-9-3-3-333-POc-qanawarisa-a)
...
[POc &ast;_boŋi rua_](cognatesetreferences.csv#cldf:2-9-3-3-334-POc-boirua-a)
...
[PAn &ast;_ijan_](cognatesetreferences.csv#cldf:2-9-3-5-335-POc-ican-a)

[POc &ast;_&#91;i&#93; ŋaican_](cognatesetreferences.csv#cldf:2-9-3-5-335-POc-iaican-a)

[POc &ast;_&#91;i&#93; ŋican_](cognatesetreferences.csv#cldf:2-9-3-5-335-POc-iican-a)
...
[POc &ast;_&#91;qa&#93;na-ŋaican_](cognatesetreferences.csv#cldf:2-9-3-5-336-POc-qanaaican-a)
...
[PPn &ast;_qā-fea_](cognatesetreferences.csv#cldf:2-9-3-5-337-PPn-qafea-a)

[PPn &ast;_&#91;qa&#93;na-fea_](cognatesetreferences.csv#cldf:2-9-3-5-337-PPn-qanafea-a)
...
[^4]: [Foley](Source#cldf:Foley1997) ([1997](Source#cldf:Foley1997):207) is careful to point out that Whorf is not talking about thought per se but about the kinds of conceptual systems that people use to construe experience.
...
[^9]:     Each of the two seasons which make up the Gilbertese year, _Nei Auti_ (Pleiades) and _Rimʷimāta_ (Antares) is divided into eight shorter periods called _boŋ_, each separately named (see [Grimble 1931](Source#cldf:Grimble1931):201).

[^10]: Reconstructed on the basis of Proto Minahasan _&ast;dm̅dm̅_ ‘dark’ ([Sneddon 1978](Source#cldf:Sneddon1978)) and the Oceanic reflexes shown here.

[^11]: Blust (ACD) glosses this ‘day’, but the gloss given here appears more consonant with the data.

[^12]: Tongan _ʔahoʔataa_ ‘at noon today’ seems at first sight to belong here, but, as [Churchward](Source#cldf:Churchward1959) ([1959](Source#cldf:Churchward1959)) shows, it reflects a probably unrelated base _-hoʔatā_.

[^13]: ‘New moon’ is also used in this sense in everyday English.

[^14]: Sources listing days of the moon’s age are [Christian](Source#cldf:Christian1899) ([1899](Source#cldf:Christian1899):387–395) for Yapese, Ponapean, Lamotrek, Mortlockese and Woleaian, [Jackson and Marck](Source#cldf:JacksonandMarck1991) ([1991](Source#cldf:JacksonandMarck1991)) for Carolinian, [Lee](Source#cldf:Lee1976) ([1976](Source#cldf:Lee1976)) for Kosraean, [Tregear](Source#cldf:Tregearnd) ([n.d.](Source#cldf:Tregearnd)) for Hawai’ian, Tahitian, Marquesan, Rarotongan, Māori and Moriori, [Stimson](Source#cldf:Stimson1928) ([1928](Source#cldf:Stimson1928)) for Tahitian, [Williams](Source#cldf:Williams1928) ([1928](Source#cldf:Williams1928)) for Hawai’ian, Mangareva, Tahitian, Marquesan, Rarotongan, and Māori.
