...
This chapter presents reconstructions pertaining to the inanimate marine environment, the seascape.[^1] As experienced sailors (see Chapter 6), Proto Oceanic speakers would have possessed a vocabulary to express the physical details of their maritime world, of waves, currents and swells, and, more locally, of tides, of treacherous rocks and reefs, of passages through the reef and sheltered water. As fishermen and gatherers of reef foods their descendants have demonstrated an extensive knowledge of the reef in all its parts ([McEldowney 1995](Source#cldf:Mceldowney1995), [Hviding 1996](Source#cldf:Hviding1996), [Akimichi 1978](Source#cldf:Akimichi1978), [Dye 1983](Source#cldf:Dye1983)). Data have been organized within two main categories: (i) the sea and its features — currents, waves and tides; and (ii) the reef environment.

As in Chapter 3, some of the nouns reconstructed here had both a common-noun and a local-noun sense. It is the common-noun senses that are treated here. For further discussion and reconstruction of local-noun senses, see [Chapter 8, §2](ContributionTable?anchor=s-2#cldf:2-8).
...
[PMP &ast;_tasik_](cognatesetreferences.csv#cldf:2-4-2-1-92-POc-tasik-a)
...
[2-4-2-1-93-ses-lau-asiabua](cf.csv#cldf:2-4-2-1-93-ses-lau-asiabua)
...
POc _&ast;masawa(n,ŋ)_ has reflexes in both Western Oceanic and Eastern Oceanic meaning ‘deep ocean’ or ‘open sea’. It appears also to have had the sense ‘open space, clear space’ and to be etymologically related to POc _&ast;sawa(n,ŋ)_ ‘channel, passage’ ([§3.5](ContributionTable?anchor=s-3-5#cldf:2-4)).

[POc &ast;_masawa(n,ŋ)_](cognatesetreferences.csv#cldf:2-4-2-1-93-POc-masawan-a)

Polynesian languages reflect another term for ‘ocean’:

[PPn &ast;_moana_](cognatesetreferences.csv#cldf:2-4-2-1-93-PPn-moana-a)
...
[PCEMP &ast;_laman_](cognatesetreferences.csv#cldf:2-4-2-1-94-POc-laman-a)
...
[PMP &ast;_lahud_](cognatesetreferences.csv#cldf:2-4-2-1-95-POc-laur-a)
...
For sheltered or calm water, reflexes of POc _&ast;[ma-[d]]rapu_ ‘still, calm, windless’ or POc _&ast;malino_ ‘calm’ were used (for the full cognate sets see [Chapter 5, §5.1](ContributionTable?anchor=s-5-1#cldf:2-5)). In Proto Eastern Oceanic, sheltered seas were referred to as ‘dead’ (_&ast;mate_), while open or exposed seas were described as ‘alive’ (_&ast;maqurip_). Codrington and Palmer write that this distinction also occurs in Malagasy (1896:205).

[PEOc &ast;_tasik mate_](cognatesetreferences.csv#cldf:2-4-2-2-95-PEOc-tasikmate-a)


<a id="p-96"></a>

[PEOc &ast;_tasik maquri(p)_](cognatesetreferences.csv#cldf:2-4-2-2-96-PEOc-tasikmaqurip-a)
...
[2-4-2-2-96-pt-kiriwina-ipaisaga](cf.csv#cldf:2-4-2-2-96-pt-kiriwina-ipaisaga)
...
[PMP &ast;_qaRus_](cognatesetreferences.csv#cldf:2-4-2-3-96-POc-qarus-a)
...
[PAn &ast;_ma-qañud_](cognatesetreferences.csv#cldf:2-4-2-3-97-POc-maqanur-a)

[POc &ast;_tape_](cognatesetreferences.csv#cldf:2-4-2-3-97-POc-tape-a)


<a id="p-98"></a>

[PAn &ast;_qaluR(?)_](cognatesetreferences.csv#cldf:2-4-2-3-98-POc-qalir-a)

[PMP &ast;_saliR_](cognatesetreferences.csv#cldf:2-4-2-3-98-POc-salir-a)
...
[PAn &ast;_ma-qaCi_](cognatesetreferences.csv#cldf:2-4-2-6-103-POc-maqati-a)
...
POc _&ast;[ma]maca_ ‘dry up, evaporate’, has some reflexes which refer to low tide or to exposure of the reef at low tide. These may represent parallel semantic specialisations. (See also [Chapter 7, §5.6](ContributionTable?anchor=s-5-6#cldf:2-7))

[PMP &ast;_maja_](cognatesetreferences.csv#cldf:2-4-2-6-105-POc-mamaca-a)
...
[PMP &ast;_Ruab_](cognatesetreferences.csv#cldf:2-4-2-6-106-POc-uruap-a)

POc _&ast;ma-[u]Ruap_ and its counterpart, _&ast;ma-qati_ ‘low tide; be low tide, to ebb’ each had both a dynamic and a stative sense ([Evans & Ross 2001](Source#cldf:EvansandRoss2001)).

[POc &ast;_&#91;ma-&#93;uRua(p)_](cognatesetreferences.csv#cldf:2-4-2-6-106-POc-mauruap-a)

Other reconstructions for high tide include the following (see also POc _&ast;lomak_ ‘flood, of sea’ (Ch. 3, p.87)):

[PMP &ast;_lubuk_](cognatesetreferences.csv#cldf:2-4-2-6-106-POc-lubuk-a)


<a id="p-107"></a>

[PWOc &ast;_tunan_](cognatesetreferences.csv#cldf:2-4-2-6-107-PWOc-tunan-a)
...
[PMP &ast;_buŋa_](cognatesetreferences.csv#cldf:2-4-3-1-108-POc-bua-a)

In Polynesian languages, reflexes of _&ast;puŋa_ typically contrast with those of _&ast;feo_.

[PPn &ast;_feo_](cognatesetreferences.csv#cldf:2-4-3-1-108-PPn-feo-a)
...
[__Figure 3:__ Reef forms](MediaTable#cldf:fig-2-3)
...
[POc &ast;_oda_](cognatesetreferences.csv#cldf:2-4-3-2-110-POc-oda-a)

However, further evidence supporting oda as a term for ‘reef’ lies in two reconstructions made by Ross [Clark](Source#cldf:Clark1991) ([1991](Source#cldf:Clark1991)), POc _&ast;paŋ-oda_ ‘gather shellfish and other seafood on the reef’ and _&ast;p-in-aŋ-oda_ ‘shellfish, seafood gathered on the reef’ (where _&ast;paŋ-_ is the verbal suffix (underlying form _&ast;paN-_) and _-in-_ the noun-deriving infix discussed in [vol.1,29](ContributionTable?anchor=p-29#cldf:1-2) and p.33 respectively). A selection of reflexes follows:

[2-4-3-2-110-pt-motu-haoda](cf.csv#cldf:2-4-3-2-110-pt-motu-haoda)
...
A second Polynesian example comes from Niuatoputapu, an island with a volcanic ridge and fringing reef located halfway between Tonga and Samoa. [Dye](Source#cldf:Dye1983) ([1983](Source#cldf:Dye1983):246) records a local division of the marine environment into four major biotopes: the reef flat (_namo_) including littoral zones, the shallow salt-water lagoon (_tahi_), the living fringing and barrier reef fronts (_mataʔuluʔulu_) and the open ocean (_moana_). The reef flat and reef edge are further divided into leeward and windward zones, although Dye gives the local name only for the windward reef flat, _lafo-lafo_.

<a id="fig-2-4"> </a>

[__Figure 4:__ Tikopia reef profile ([Firth 1985](Source#cldf:Firth1985):613, reproduced with permission)](MediaTable#cldf:fig-2-4)
...
[PPn &ast;_tuqa-hakau_](cognatesetreferences.csv#cldf:2-4-3-2-112-PPn-tuqahakau-a)
...
[PCP &ast;_qulu-qulu_](cognatesetreferences.csv#cldf:2-4-3-2-112-PCP-quluqulu-a)
...
[POc &ast;_mʷaloq_](cognatesetreferences.csv#cldf:2-4-3-3-113-POc-maloq-a)
...
[PEOc &ast;_nuku potu_](cognatesetreferences.csv#cldf:2-4-3-3-114-PEOc-nukupotu-a)

Both the SE Solomonic and Micronesian reflexes of PEOc _&ast;baro_ refer to flat rocks in or near the sea.

[PEOc &ast;_baro_](cognatesetreferences.csv#cldf:2-4-3-3-114-PEOc-baro-a)

[PPn &ast;_toka_](cognatesetreferences.csv#cldf:2-4-3-3-114-PPn-toka-a)

Reflexes of POc _&ast;baban_ ‘flat; flat rock, any hard flat surface’ are also used in some languages to refer to flat rock surfaces underwater (see [vol.1,58](ContributionTable?anchor=p-58#cldf:1-3)).
...
[POc &ast;_loto_](cognatesetreferences.csv#cldf:2-4-3-4-115-POc-loto-a)
...
[POc &ast;_wasas_](cognatesetreferences.csv#cldf:2-4-3-5-117-POc-wasas-a)
...
[^2]: In Iaai _mʰ_ reflects PNCal _&ast;mm_ and POc _&ast;mam_. (For a fuller discussion, see [Ozanne-Rivierre 1986](Source#cldf:OzanneRivierre1986):39.)